...
On 2005-07-08 the ArchWiki was first set up on the  engine.
...
The 2012-07-15 release of the installation image deprecated the menu-driven Arch Installation Framework (AIF) in favor of the Arch Install Scripts ().

## The systemd era
Between 2012 and 2013 the traditional UNIX System V init system was replaced by systemd. === Drop of i686 support ===

On 2017-01-25 it was [https://archlinux.org/news/phasing-out-i686-support/ announced that support for the i686 architecture would be phased out due to its decreasing popularity among the developers and the community. By the end of November 2017, all i686 packages were removed from the mirrors.
...
Several months later, in November 2023, the old Flyspray bug tracker bugs.archlinux.org was migrated to gitlab.archlinux.org and its collaboration features—issues and merge requests—were opened to the public. For archiving reasons there remains a static copy of the old bug tracker, so that links—for example the randomly picked —are still valid.
