...
; tar4ibd: A patched version of tar for handling InnoDB data safely.

In all of the below examples, the following is assumed:

* You are backing up a server whose data is stored in , which is the standard location for Arch Linux
* You are storing the backups in
* You have a my.cnf file in a standard location, such as , with at least the following contents:
