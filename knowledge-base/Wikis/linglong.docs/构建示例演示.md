...
## 配置 linglong.yaml 配置文件 [​](#配置-linglong-yaml-配置文件)

### 配置软件包元数据信息 [​](#配置软件包元数据信息)
...
### 完整的 linglong.yaml 配置文件 [​](#完整的-linglong-yaml-配置文件)
...
更多配置文件字段定义请参考[配置文件说明文档](./manifests.html)
...
[完整示例](./../start/build_your_first_app.html) - 包含了如何构建应用、导出构建内容、安装、运行等完整流程的示例。