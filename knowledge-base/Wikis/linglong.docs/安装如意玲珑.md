...
### release 仓库 [​](#release-仓库)

基于最新tag自动构建

1.  仓库地址 [https://ci.deepin.com/repo/obs/linglong:/CI:/release](https://ci.deepin.com/repo/obs/linglong:/CI:/release)
2.  构建地址 [https://build.deepin.com/project/show/linglong:CI:release](https://build.deepin.com/project/show/linglong:CI:release)

### latest 仓库 [​](#latest-仓库)

基于最新提交自动构建

1.  仓库地址 [https://ci.deepin.com/repo/obs/linglong:/CI:/latest](https://ci.deepin.com/repo/obs/linglong:/CI:/latest)
2.  构建地址 [https://build.deepin.com/project/show/linglong:CI:latest](https://build.deepin.com/project/show/linglong:CI:latest)
...
### Arch / Manjaro / Parabola Linux [​](#arch-manjaro-parabola-linux)
...
## 如意玲珑转换工具安装说明 [​](#如意玲珑转换工具安装说明)

### Deepin 23/25 [​](#deepin-23-25)
