# 玲珑仓库 mirror 功能设计 [​](#玲珑仓库-mirror-功能设计)
...
当添加contenturl配置项后，ostree会优先使用contenturl下载静态文件如files, url仅用于获取元数据如summary, contenturl支持file://、http://、[https://三种协议](https://xn--ehq71kvz3be7o)。
