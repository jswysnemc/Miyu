...
## COMMANDS [​](#commands)
  ...
  --------- ---------------------------------------------- ---------------------------------
  adep      [ll-pica-adep(1)](./ll-pica-adep.html)         给 linglong.yaml 文件添加包依赖
  convert   [ll-pica-convert(1)](./ll-pica-convert.html)   将 deb 包转换为玲珑包
  init      [ll-pica-init(1)](./ll-pica-init.html)         初始化转换包的配置信息

## SEE ALSO [​](#see-also)

**[ll-builder(1)](./../ll-builder/ll-builder.html)**, **[ll-pica-adep(1)](./ll-pica-adep.html)**, **[ll-pica-convert(1)](./ll-pica-convert.html)**, **[ll-pica-init(1)](./ll-pica-init.html)**
