...
ro
read-only flag of subvolume: true or false. Please also see section *SUBVOLUME FLAGS* in `btrfs-subvolume` for possible implications regarding incremental send.
