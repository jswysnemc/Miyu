...
take a look at the
[Mesa matrix](https://mesamatrix.net/#Vulkan).
...
[The exact list of Vulkan conformant products can be seen here.](https://www.khronos.org/conformance/adopters/conformant-products)
...
[see the src/amd/common/amd_family.h file](https://gitlab.freedesktop.org/mesa/mesa/-/blob/main/src/amd/common/amd_family.h).
...
[Read its documentation here.](https://gitlab.freedesktop.org/mesa/mesa/-/blob/main/src/amd/compiler/README.md)
...
AMD hardware on the [X.Org wiki](https://www.x.org/wiki/RadeonFeature/#documentation).
