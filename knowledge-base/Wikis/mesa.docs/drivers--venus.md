...
definition and codegen are hosted at [venus-protocol](https://gitlab.freedesktop.org/virgl/venus-protocol).  The renderer is
hosted at [virglrenderer](https://gitlab.freedesktop.org/virgl/virglrenderer).
...
implementation-defined behaviors to support `vkMapMemory` (see [below](#vk-memory-property-host-visible-bit)).  It is not expected to work on all
...
- ANV 21.1 or later
   - Note: with Intel Meteor Lake or xe driver, you need 6.16+ kernel and 11.0+
     ...
     [here](https://gitlab.com/qemu-project/qemu/-/work_items/3357)).
- RADV 21.1 or later
   - Note: you need 6.13+ kernel that already has
     [KVM: Stop grabbing references to PFNMAP'd pages](https://lore.kernel.org/all/20241010182427.1434605-1-seanjc@google.com/).
...
paired with hypervisors such as [crosvm](https://crosvm.dev), or [QEMU](https://www.qemu.org).
...
[here](https://gitlab.freedesktop.org/gfx-ci/android/aosp-manifest/-/blob/android16-release+venus/README.md).
