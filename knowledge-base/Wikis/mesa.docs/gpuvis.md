...
[Gpuvis](https://github.com/mikesart/gpuvis) is a tool to visualize ftrace
...
[scripts](https://github.com/mikesart/gpuvis/tree/master/sample) for
...
SteamOS includes a script ([gpu-trace](https://github.com/lostgoat/gpu-trace))
to capture traces.
