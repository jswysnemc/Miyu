...
- [Meson](https://mesonbuild.com) is required when building on *nix
...
- [Python](https://www.python.org/) - Python 3.10 or newer is required.
- Python package `packaging` is required on Python 3.12+:
  `pip install packaging`
- [Python Mako module](https://www.makotemplates.org/) - Python Mako
