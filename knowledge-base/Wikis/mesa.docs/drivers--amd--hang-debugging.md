...
[UMR](https://gitlab.freedesktop.org/tomstdenis/umr). Do not forget to run
...
saved to `$HOME/radv_dumps_<pid>_<time>`. Inside the directory of the hang report,
...
* `bo_history.log`: A list of every GPU memory allocation and deallocation.
  ...
  [radv_check_va.py](https://gitlab.freedesktop.org/mesa/mesa/-/blob/main/src/amd/vulkan/radv_check_va.py)
