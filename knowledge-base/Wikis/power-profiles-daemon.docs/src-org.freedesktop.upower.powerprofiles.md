# Src / Org.Freedesktop.Upower.Powerprofiles
...
<node>
  ...
  <interface name="@dbus_iface@">
    ...
    <!--
        ...
        Those holds will be automatically canceled if the user manually switches
    ...
    <!--
        ...
        This sets a particular action to be enabled or disabled. The daemon
        will only allow the action to be executed on power state changes if
        it is enabled.
    -->
    ...
    <!--
        ...
        reason if they do not recognize the value. Possible values are:
    ...
    <!--
        ...
        An array of key-pair values representing each action. The key named
        "Description" (s) is a human-readable description of the action.
        The key named "Action" (s) is the name of the action.
        The key named "Enabled" (b) is a boolean indicating whether the action
        is enabled or not.
    -->
