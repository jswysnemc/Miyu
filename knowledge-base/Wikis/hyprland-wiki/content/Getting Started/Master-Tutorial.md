...
See Installation and come back here once you have
...
Please take a look at The Nvidia page before launching. It has
...
Check out the Preconfigured setups page
...
See the Must-have Software page for the
crucial things to make Wayland / Hyprland / other apps work correctly.

## Monitors config

See Configuring Hyprland page to learn all about
configuring your displays.

## Apps / X11 replacements

See the Useful Utilities page
