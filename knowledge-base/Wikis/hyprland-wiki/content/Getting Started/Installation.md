...
> [!NOTE]
> NVIDIA GPUs are often not usable out-of-the-box, follow the Nvidia page after installing
...
"Manual (Manual Build)" to build Hyprland yourself.
...
installing hyprland-git from the aur or
building manually.
> [!WARNING]
