...
Splitting hyprland's configuration across multiple files is an easier way of managing the configuration. To source or reference other files we use lua's require function. 
