...
The specification's repository contains a description of the current **type 2** format. You can find the [full text](https://github.com/AppImage/AppImageSpec/blob/master/draft.md) in the [GitHub repository](https://github.com/AppImage/AppImageSpec/).
...
Please feel free to file [issues on GitHub](https://github.com/AppImage/AppImageSpec/issues) if you encounter bugs or have ideas for additional features. Also, improvements on wording etc. are highly appreciated.

## Reference implementation

The project maintains a reference implementation of the standard which is called `ref-appimagekit`.
