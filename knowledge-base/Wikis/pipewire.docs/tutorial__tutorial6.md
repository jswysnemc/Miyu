...
Tutorial - Part 5: Capturing Video Frames | Index | Tutorial - Part 7: Creating an Audio DSP Filter
...
Most of this is the same as Tutorial - Part 2: Enumerating Objects where we simply
...
We use the `pw_registry_bind()` method on our registry object like this:
 ...
 tutorial6.c registry_event_global
