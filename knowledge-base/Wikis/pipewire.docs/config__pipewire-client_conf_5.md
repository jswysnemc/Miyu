...
pipewire-props(7) Common Node Properties
and
pipewire-props(7) Audio Adapter Properties

# STREAM RULES  @IDX@ client.conf stream.rules

You can add match rules, see pipewire(1)
...
Match rules, see pipewire(1). You can
...
See pipewire(1) for common environment
