...
SPA plugins are dynamically loadable objects that contain objects and interfaces that
...
**Note:** The directory the SPA plugins reside in is available through
