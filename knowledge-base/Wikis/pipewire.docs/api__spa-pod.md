...
spa_pod (plain old data) is a sort of data container. It is comparable to
...
case SPA_CHOICE_Range:
	...
	if (n_vals < 3)
		break;
	printf("default value: %u", v[0]);
	printf("min value: %u", v[1]);
	printf("max value: %u", v[2]);
	break;
