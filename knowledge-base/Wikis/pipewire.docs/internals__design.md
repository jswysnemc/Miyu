...
PipeWire uses the SPA plugin API for the nodes in the graph.
...
See Protocol Native for details.
See also Native Protocol for the documentation of the protocol
messages.
...
graph in some way. See Modules for a list of current
modules.
