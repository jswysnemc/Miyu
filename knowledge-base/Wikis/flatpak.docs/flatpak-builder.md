...
`flatpak-builder` has already been introduced in [Building your first Flatpak](first-build.md) and [Building Introduction](building-introduction.md). It is packaged by most of the popular distributions and there is also a flatpak-builder [Flatpak package](https://flathub.org/apps/org.flatpak.Builder) on Flathub (this may contain Flathub specific downstream modifications).
