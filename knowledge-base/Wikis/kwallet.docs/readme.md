...
## Known Issues
To use a GPG wallet while ksecretd is enabled, add the `no-allow-external-cache` option to your `$HOME/.gnupg/gpg-agent.conf` ([BUG: 458085](https://bugs.kde.org/458085)).
