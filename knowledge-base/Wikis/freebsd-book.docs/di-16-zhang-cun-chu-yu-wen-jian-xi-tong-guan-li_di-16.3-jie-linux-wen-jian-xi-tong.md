> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-16-zhang-cun-chu-yu-wen-jian-xi-tong-guan-li/di-16.3-jie-linux-wen-jian-xi-tong.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-16-zhang-cun-chu-yu-wen-jian-xi-tong-guan-li/di-16.3-jie-linux-wen-jian-xi-tong.md)
...
文件系统卸载操作可通过 `umount` 命令完成，卸载前应确保没有进程正在访问挂载点，否则卸载将失败。如果挂载点被占用，可使用 `umount -f` 强制卸载（可能导致正在访问该文件系统的应用程序出现未定义行为）。其基本语法为：
