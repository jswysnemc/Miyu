> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/hou-ji/wo-yu-freebsd-de-gu-shi.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/hou-ji/wo-yu-freebsd-de-gu-shi.md)
...
FreeBSD 这里的教程比较少，大多数没什么坑，也可能是基数问题导致的，用户太少了。大部分通过百度搜到的，都是什么系统安装，还在用 pkg_add 这种十年前的命令。再深入就是什么 FNMP（FreeBSD, Nginx, MySQL, PHP）这种东西的配置。
