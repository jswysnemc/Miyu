> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-25-zhang-web-fu-wu-qi/di-25.2-jie-nginx-web-fu-wu-qi.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-25-zhang-web-fu-wu-qi/di-25.2-jie-nginx-web-fu-wu-qi.md)

---

# 25.2 Nginx Web 服务器

Nginx 采用事件驱动异步架构与多进程单线程工作模式，以低内存消耗实现高并发。本节涵盖 pkg 安装与基础配置。
...
确认 Nginx 服务正常运行后，可通过浏览器访问，验证 Web 服务器是否工作正常。
