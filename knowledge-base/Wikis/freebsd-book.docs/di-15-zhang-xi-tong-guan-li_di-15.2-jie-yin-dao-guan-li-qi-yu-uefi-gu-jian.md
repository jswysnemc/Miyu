> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-15-zhang-xi-tong-guan-li/di-15.2-jie-yin-dao-guan-li-qi-yu-uefi-gu-jian.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-15-zhang-xi-tong-guan-li/di-15.2-jie-yin-dao-guan-li-qi-yu-uefi-gu-jian.md)
...
> **警告**
>
> 不要使用 `efibootmgr -o 0000` 直接指定启动顺序，这样会将 BootOrder 设置为仅包含 0000，导致其他启动项被排除在启动顺序之外（启动项本身仍然存在，但不会被固件尝试引导）。
