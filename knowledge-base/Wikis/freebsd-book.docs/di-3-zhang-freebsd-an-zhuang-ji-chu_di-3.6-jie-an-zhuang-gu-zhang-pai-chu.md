> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-3-zhang-freebsd-an-zhuang-ji-chu/di-3.6-jie-an-zhuang-gu-zhang-pai-chu.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-3-zhang-freebsd-an-zhuang-ji-chu/di-3.6-jie-an-zhuang-gu-zhang-pai-chu.md)
...
如果出现 ACPI 错误提示，大多数情况下不影响正常使用。通常可通过更新主板 BIOS 或固件解决。少数情况下可能需要修补 SSDT（Secondary System Description Table，次级系统描述表）和 DSDT（Differentiated System Description Table，差异化系统描述表）。
