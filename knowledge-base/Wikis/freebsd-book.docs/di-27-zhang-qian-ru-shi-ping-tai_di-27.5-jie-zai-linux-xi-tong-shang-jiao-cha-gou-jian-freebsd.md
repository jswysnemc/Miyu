> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-27-zhang-qian-ru-shi-ping-tai/di-27.5-jie-zai-linux-xi-tong-shang-jiao-cha-gou-jian-freebsd.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-27-zhang-qian-ru-shi-ping-tai/di-27.5-jie-zai-linux-xi-tong-shang-jiao-cha-gou-jian-freebsd.md)

---

# 27.5 在 Linux 系统上交叉构建 FreeBSD

在 Linux（以 Ubuntu 24.04 LTS 为例）上交叉构建 FreeBSD 需要至少 12 GB 内存与 16 GB swap。本节给出从环境准备到完整构建的步骤。

## 设备环境

本节以 Ubuntu 24.04 LTS 为例说明，其他 Linux 发行版也可参考。构建过程内存消耗较大，建议配置如下：
...
如果没有图形界面，可使用终端复用工具（如 `tmux` 或 `screen`）保持会话运行。
