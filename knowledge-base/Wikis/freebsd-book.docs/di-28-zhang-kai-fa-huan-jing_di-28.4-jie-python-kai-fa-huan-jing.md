> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-28-zhang-kai-fa-huan-jing/di-28.4-jie-python-kai-fa-huan-jing.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-28-zhang-kai-fa-huan-jing/di-28.4-jie-python-kai-fa-huan-jing.md)
...
在 FreeBSD Ports 中，不同版本 Python 的 pkg 二进制包支持程度随版本演进而有所不同。

例如，当前 `lang/python`（实际上仅为元包，即指向其他软件包的依赖包）指向 Python 3.13，则通过 pkg 安装的其他 Python 包（如 Python-XX）在默认情况下也会以此版本为基础构建；其他依赖 Python 的软件同样依赖该版本。
