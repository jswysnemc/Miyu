> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-15-zhang-xi-tong-guan-li/di-15.5-jie-yong-hu-fen-ji-wen-jian-login-conf.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-15-zhang-xi-tong-guan-li/di-15.5-jie-yong-hu-fen-ji-wen-jian-login-conf.md)
...
普通用户可通过主目录下的 **~/.login_conf** 文件覆盖系统级配置，该文件仅包含一条记录 ID 为“me”的条目。但仅部分登录能力可覆盖，通常仅限于不涉及认证、资源限制和计费的环境设置；系统级配置文件 **/etc/login.conf** 的优先级低于用户本地配置。
