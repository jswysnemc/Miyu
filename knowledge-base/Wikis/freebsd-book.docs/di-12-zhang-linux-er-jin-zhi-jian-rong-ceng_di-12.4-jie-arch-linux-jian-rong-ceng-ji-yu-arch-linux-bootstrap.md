> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.4-jie-arch-linux-jian-rong-ceng-ji-yu-arch-linux-bootstrap.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.4-jie-arch-linux-jian-rong-ceng-ji-yu-arch-linux-bootstrap.md)
...
> **技巧**
>
> 如果为用户 `test` 设置了密码后仍提示密码错误，需打开新终端，执行 `reboot` 命令重启 FreeBSD，然后继续操作。
