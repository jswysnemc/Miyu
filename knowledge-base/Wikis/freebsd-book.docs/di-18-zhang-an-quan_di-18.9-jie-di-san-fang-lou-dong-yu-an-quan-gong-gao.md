> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.9-jie-di-san-fang-lou-dong-yu-an-quan-gong-gao.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.9-jie-di-san-fang-lou-dong-yu-an-quan-gong-gao.md)
...
- 每份安全公告均由安全官（Security Officer）的 PGP 密钥签名。可在 [OpenPGP Keys](https://docs.freebsd.org/en/books/handbook/pgpkeys/#pgpkeys) 中验证安全官公钥。
...
- `CVE Name` 字段列出公开 [CVE 数据库中](https://www.cve.org/)的公告编号（如果存在）。
