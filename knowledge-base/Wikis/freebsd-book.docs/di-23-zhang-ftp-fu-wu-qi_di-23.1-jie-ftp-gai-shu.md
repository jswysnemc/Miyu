> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-23-zhang-ftp-fu-wu-qi/di-23.1-jie-ftp-gai-shu.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-23-zhang-ftp-fu-wu-qi/di-23.1-jie-ftp-gai-shu.md)
...
| 软件 | 特点 | 适用场景和人群 |
| ---- | ---- | -------------- |
| Pure-FTPd | 类 BSD 许可证授权、安全优先、支持多种操作系统、FTP 协议规范实现较为完整 | 为 ISP 和托管服务提供高度灵活性，适用于新手 |
| ProFTPD | GPLv2 许可证授权、支持多种操作系统、单一主配置文件、可扩展性强 | 适合熟悉 Apache HTTP Server 的用户（语法类似） |
| vsftpd | GPLv2 许可证授权、支持 IPv6 和 SSL 加密、支持虚拟用户、虚拟 IP、细粒度用户与 IP 控制、带宽限制 | 面向生产环境 |
