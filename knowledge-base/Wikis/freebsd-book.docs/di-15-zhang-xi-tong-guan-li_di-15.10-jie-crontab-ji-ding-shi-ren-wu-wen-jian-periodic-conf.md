> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-15-zhang-xi-tong-guan-li/di-15.10-jie-crontab-ji-ding-shi-ren-wu-wen-jian-periodic-conf.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-15-zhang-xi-tong-guan-li/di-15.10-jie-crontab-ji-ding-shi-ren-wu-wen-jian-periodic-conf.md)

---

# 15.10 Cron 和 Periodic
...
> **技巧**
>
> 上述示例中的 `/home/ykla/bin`、`email1@example.com`、`email2@example.com` 为占位符，须替换为实际的值。
