> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-29-zhang-freebsd-nei-he-jia-gou/di-29.1-jie-freebsd-yuan-dai-ma-mu-lu-jie-gou.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-29-zhang-freebsd-nei-he-jia-gou/di-29.1-jie-freebsd-yuan-dai-ma-mu-lu-jie-gou.md)

---

# 29.1 FreeBSD 源代码目录结构

如果尚未安装源代码，请参考前文使用 Git 获取源代码的章节。

FreeBSD 系统源代码按功能划分为 bin、lib、share、usr.bin 等目录层级，整体结构以树状图展示。
...
├── .arclint                     # 用于 Lint 检查
├── .cirrus-ci                   # Cirrus CI 用于安装 pkg 的脚本
...
内核源代码是 FreeBSD 系统的核心，了解其目录结构有助于理解系统架构。下图展示了内核源代码的整体组织：
