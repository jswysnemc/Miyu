> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.7-jie-openssl.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.7-jie-openssl.md)
...
需要通过 Ports 参照 [FIPS 已验证版本清单](https://www.openssl.org/source/)安装经过认证的 OpenSSL 版本。然后将 **fips.so** 库复制到对应位置。
