> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.2-jie-rocky-linux-jian-rong-ceng.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.2-jie-rocky-linux-jian-rong-ceng.md)

---

# 12.2 Rocky Linux 兼容层
...
无需配置 **/etc/fstab** 文件，`linux_mounts_enable` 服务会自动挂载所需的文件系统条目。
