> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.6-jie-opensuse-jian-rong-ceng.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.6-jie-opensuse-jian-rong-ceng.md)
...
echo ""
echo "I will set resolv.conf to Ali DNS"              # 提示将 DNS 设置为阿里云公共 DNS
...
需要指出的是，Tumbleweed 即风滚草，是 openSUSE 的滚动更新版本。
...
具体而言，在使用 openSUSE Tumbleweed 时，dnf 和 zypper 均不可用。该问题不影响 Leap 对应的脚本，但影响 Tumbleweed 对应的脚本，导致无法正常使用。已提交 [Bug 报告](https://bugzilla.opensuse.org/show_bug.cgi?id=1213158)。
