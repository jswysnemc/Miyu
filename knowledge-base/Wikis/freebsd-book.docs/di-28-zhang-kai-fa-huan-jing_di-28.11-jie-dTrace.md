> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-28-zhang-kai-fa-huan-jing/di-28.11-jie-dTrace.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-28-zhang-kai-fa-huan-jing/di-28.11-jie-dTrace.md)

---

# 28.11 DTrace

DTrace 源于 Sun Solaris，以 CDDL 许可证开源。FreeBSD 自 GENERIC 内核起即内置支持，由内核模块实现。
...
DTrace 工具包使用 DTrace 特有的脚本语言 D 语言，其语法与 C++ 相似。本节不对 D 语言进行深入讲解。如需概览，请参阅 FreeBSD 的 d 手册页。D 语言在 [illumos 动态跟踪指南](https://www.illumos.org/books/dtrace/bookinfo.html) 中也有详细介绍。
