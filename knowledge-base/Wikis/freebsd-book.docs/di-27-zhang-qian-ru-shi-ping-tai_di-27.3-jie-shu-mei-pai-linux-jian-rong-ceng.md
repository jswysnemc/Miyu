> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-27-zhang-qian-ru-shi-ping-tai/di-27.3-jie-shu-mei-pai-linux-jian-rong-ceng.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-27-zhang-qian-ru-shi-ping-tai/di-27.3-jie-shu-mei-pai-linux-jian-rong-ceng.md)

---

# 27.3 树莓派 Linux 兼容层

Arch Linux ARM 移植版（ALARM）针对树莓派等 ARM 设备提供滚动更新的软件源。本节提供在 FreeBSD 树莓派系统上部署 Arch Linux 兼容层的自动化脚本。
...
case $answer in
	...
	[Yy][Ee][Ss]|[Yy]|"")
		...
		echo "Install yay"
		chroot ${rootdir} /bin/bash -c "pacman -S --noconfirm yay base base-devel nano wqy-zenhei"  # 安装软件和 yay
		echo "Create user"
