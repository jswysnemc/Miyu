> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-10-zhang-duo-mei-ti-he-wai-bu-she-bei/di-10.2-jie-da-yin-ji.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-10-zhang-duo-mei-ti-he-wai-bu-she-bei/di-10.2-jie-da-yin-ji.md)
...
将 D-Bus（进程间通信总线）、avahi‑daemon（Avahi 守护进程）和 cupsd（CUPS 守护进程）服务设置为系统启动时自动启用，以确保打印服务及其自动发现功能在系统重启后仍可正常使用：
...
过程中将提示输入账号和密码，使用 `root` 用户或 `wheel` 组内的用户登录（输入其在 FreeBSD 系统中的账户密码）即可。
