> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.3-jie-ubuntu-debian-jian-rong-ceng.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-12-zhang-linux-er-jin-zhi-jian-rong-ceng/di-12.3-jie-ubuntu-debian-jian-rong-ceng.md)

---

# 12.3 Ubuntu/Debian 兼容层

本节基于 debootstrap 在 FreeBSD 上构建 Ubuntu 22.04 LTS 兼容层，并附 Debian 12 构建脚本。内容包括 X11 应用运行以及与 systemd、Wine 相关的故障排除。

> **注意**
>
> 由于 FreeBSD Ports 中的 [sysutils/debootstrap](https://www.freshports.org/sysutils/debootstrap/) 长期未更新，经测试，该工具目前尚不支持 Ubuntu 24.04 和 Debian 13 的基本系统引导。
...
将 `nullfs_load="YES"` 写入 **/boot/loader.conf** 文件。
...
检查挂载有无报错。挂载所有在 **/etc/fstab** 文件中标记为自动挂载的文件系统：
...
echo "deb-src http://mirrors.ustc.edu.cn/ubuntu/ jammy main restricted universe multiverse" >> /compat/ubuntu/etc/apt/sources.list # 写入源代码仓库
...
echo "deb-src http://mirrors.ustc.edu.cn/ubuntu/ jammy-security main restricted universe multiverse" >> /compat/ubuntu/etc/apt/sources.list # 写入安全源代码源
...
echo "deb-src http://mirrors.ustc.edu.cn/ubuntu/ jammy-updates main restricted universe multiverse" >> /compat/ubuntu/etc/apt/sources.list # 写入更新源代码源
...
echo "deb-src http://mirrors.ustc.edu.cn/ubuntu/ jammy-backports main restricted universe multiverse" >> /compat/ubuntu/etc/apt/sources.list # 写入回溯源代码源
...
echo "# deb-src http://mirrors.ustc.edu.cn/debian-security/ stable-security main non-free contrib" >> /compat/debian/etc/apt/sources.list # 写入安全源代码
