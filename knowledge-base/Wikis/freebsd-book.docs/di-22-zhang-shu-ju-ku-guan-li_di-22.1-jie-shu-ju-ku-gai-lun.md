> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-22-zhang-shu-ju-ku-guan-li/di-22.1-jie-shu-ju-ku-gai-lun.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-22-zhang-shu-ju-ku-guan-li/di-22.1-jie-shu-ju-ku-gai-lun.md)
...
- `char` 是字符类型，若需存储字符串，须指定字符数，即 `char(字符数)`
