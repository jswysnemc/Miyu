> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-22-zhang-shu-ju-ku-guan-li/di-22.3-jie-pgadmin4-guan-li-gong-ju.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-22-zhang-shu-ju-ku-guan-li/di-22.3-jie-pgadmin4-guan-li-gong-ju.md)
...
![登录 pgAdmin4](../.gitbook/assets/pglogin.png)

箭头所指处可以切换语言。

![pgAdmin4 切换语言](../.gitbook/assets/pglogin2.png)

![pgAdmin4 中文界面](../.gitbook/assets/pglogin3.png)
...
pgadmin4 更新频率较高，如需升级，必须先删除原来用 virtualenv 创建的 pgadmin4 目录，然后用安装用户再次执行如下命令，创建 Python 虚拟环境 pgadmin4：
