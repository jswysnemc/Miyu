> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-1-zhang-freebsd-chu-jian/di-1.2-jie-gnu-cao-zuo-xi-tong-he-zi-you-ruan-jian-yun-dong.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-1-zhang-freebsd-chu-jian/di-1.2-jie-gnu-cao-zuo-xi-tong-he-zi-you-ruan-jian-yun-dong.md)

---

# 1.2 GNU 操作系统和自由软件运动

理查德·斯托曼于 1983 年发起 GNU 项目，旨在创建一种完全自由且与 UNIX 兼容的操作系统。
...
在 GNU 项目初期，理查德·马修·斯托曼为 UNIX 开发了大量实用程序（用户空间组件），然而 GNU 始终未能产出稳定的内核。[**GNU Hurd**](https://hurd.gnu.org/) 是 GNU 项目的内核，采用微内核架构设计，开发始于 1990 年。尽管 GNU Hurd 已于 2025 年随 Debian GNU/Hurd 发布，但其硬件支持和软件生态仍不成熟。Linux 内核的诞生打破了这一技术僵局。
...
自由软件运动与开源运动之间存在理念差异，至今仍是软件许可领域的核心分歧之一。
...
- Stallman R. The GNU Manifesto[EB/OL]. [2026-03-26]. <https://www.gnu.org/gnu/manifesto.html>. GNU 宣言。
- Linux-libre Project. Linux-libre[EB/OL]. [2026-03-26]. <https://www.fsfla.org/ikiwiki/selibre/linux-libre/>. 一款由拉丁美洲自由软件基金会（FSFLA）维护的去除所有二进制固件的 Linux 内核变体

## 自由软件运动与开源运动的张力

自由软件运动与开源运动之间存在一定的理念差异。理查德·马修·斯托曼在私人通信中强调，GNU 与自由软件运动并不强调“开源”（甚至是反对使用这一术语），而是强调“Free”所代表的自由。部分观点将“开源”等同于 OSI 的定义，这是一种片面的观点。
...
> **技巧**
>
> 与 GPL 许可证的“著佐权”（Copyleft）机制不同，FreeBSD 项目采用更为宽松的 BSD 许可证。FreeBSD 项目的源代码中包含部分受 GNU 通用公共许可证（GPL）和 GNU 宽通用公共许可证（LGPL）许可的软件，这些许可证的著佐权（Copyleft）条款对源代码再发布施加了更严格的限制。然而，由于 GPL 软件在商业使用中可能带来额外复杂性，在合理可行的情况下，FreeBSD 项目更倾向于接受 BSD 许可证的软件提交。这一许可证选择差异是 FreeBSD 与 Linux 在软件生态治理上的核心区别。
...
自由软件与开源软件的概念常易混淆。本附录从“营利”与“盈利”的词语辨析入手，梳理自由软件的四项基本自由与 OSI 开源协议十条标准，辨析自由软件与开源软件的关系，并厘清 CC-BY-NC/ND 等非开源许可证的边界。

### 厘清“营利”和“盈利”

这两个词语含义和用法均不相同。

- “盈利”：名词，扣除成本后获得的利润，也作赢利。引自中国社会科学院语言研究所词典编辑室，编. 现代汉语词典[M]. 第 7 版. 北京：商务印书馆，2016：1572. ISBN: 978-7-100-12450-8.
- “营利”：动词，谋求利润。引自中国社会科学院语言研究所词典编辑室，编. 现代汉语词典[M]. 第 7 版. 北京：商务印书馆，2016：1572. ISBN: 978-7-100-12450-8.

### 自由软件定义：四项基本自由

> 一种软件若为自由软件，必须为用户提供以下四项基本自由：
>
...
OSI 基于开源定义（OSD）所认证的开源许可证，已成为全球公认的开放软件判定标准，并因国际组织、产业界与政府政策的采纳而确立了权威性。
...
- 专有软件/私有软件（Proprietary Software）：即真正意义上的“非自由软件”，GNU 宣言最初的目标即消除此类非自由软件，大部分商业软件属此类型。
- 免费软件：界定标准不一。前述各类软件均可能免费分发，但免费本身不构成其性质的判定依据。
- 商业软件：商业软件由企业作为其业务的一部分开发。
...
- 推论 3：商业软件不一定是私有软件或专有软件。反之，私有软件或专有软件也不一定是商业软件（如将个人项目以非营利目的闭源分发给朋友）。

### 自由/开源软件与免费

依据“自由度 2：用户可以自由地分发该软件的拷贝”及 GPLv2/v3 等相关开源协议的条款，上述协议并未限制开源软件的营利行为。红帽公司（Red Hat）便是典型例子。

开源软件/自由软件不等于免费。

### 开源不等于无版权

部分公众会混淆开源与无版权，而“开源即无版权”这一观点实际存在逻辑问题：如果不持有版权，便无法要求他人遵守开源协议。部分人会将版权转交给自由软件基金会，但版权在事实上依然存在。
