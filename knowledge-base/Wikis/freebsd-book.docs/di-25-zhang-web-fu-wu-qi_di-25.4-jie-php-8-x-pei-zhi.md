> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-25-zhang-web-fu-wu-qi/di-25.4-jie-php-8-x-pei-zhi.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-25-zhang-web-fu-wu-qi/di-25.4-jie-php-8-x-pei-zhi.md)
...
- FreeBSD Project. PHP-FPM(8)[EB/OL]. [2026-03-25]. <https://man.freebsd.org/cgi/man.cgi?query=php-fpm&sektion=8>. 系统阐述了 PHP-FPM 进程管理机制及配置参数。
...
> **技巧**
>
> 上述示例中的 `192.168.179.150` 为占位符，须替换为实际的值。
