> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-23-zhang-ftp-fu-wu-qi/di-23.4-jie-vsftpd.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-23-zhang-ftp-fu-wu-qi/di-23.4-jie-vsftpd.md)

---

# 23.4 vsftpd

vsftpd（Very Secure FTP Daemon，即“非常安全的 FTP 守护进程”）注重安全性设计，在 Linux 系统中应用较为广泛。实测表明，Windows 环境下的 FTP 客户端不会出现乱码。
...
创建并编辑 **/usr/local/etc/vsftpd.chroot_list** 文件，加入用户 `ftptest`。
