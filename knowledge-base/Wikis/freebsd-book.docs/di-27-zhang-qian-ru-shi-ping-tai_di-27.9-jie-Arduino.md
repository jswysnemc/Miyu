> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-27-zhang-qian-ru-shi-ping-tai/di-27.9-jie-Arduino.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-27-zhang-qian-ru-shi-ping-tai/di-27.9-jie-Arduino.md)
...
Arduino 2.x 是 Arduino IDE 的最新版本，使用 electron 开发。

需要先行部署 Linux 兼容层。

授予可执行文件 **arduino-ide** 执行权限后可直接运行：
