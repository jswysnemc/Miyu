> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-8-zhang-x-window-xi-tong/di-8.1-jie-xian-ka-qu-dong-gai-shu.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-8-zhang-x-window-xi-tong/di-8.1-jie-xian-ka-qu-dong-gai-shu.md)
...
提示内核版本不符，请先升级系统或使用 ports 编译安装。14.3-RELEASE 及以上版本可使用内置的内核模块源（参见其他章节），应不致出现类似问题。
