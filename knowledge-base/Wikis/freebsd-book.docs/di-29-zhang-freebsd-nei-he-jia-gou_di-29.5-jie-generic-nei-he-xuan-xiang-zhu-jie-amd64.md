> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-29-zhang-freebsd-nei-he-jia-gou/di-29.5-jie-generic-nei-he-xuan-xiang-zhu-jie-amd64.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-29-zhang-freebsd-nei-he-jia-gou/di-29.5-jie-generic-nei-he-xuan-xiang-zhu-jie-amd64.md)

---

# 29.5 GENERIC 内核选项注解（AMD64）
...
为便于说明，并避免引入对大多数非开发者无用的调试选项，本节以 15.0-RELEASE（releng/15.0 分支）的 GENERIC 内核选项为例说明。

- 原文：[sys/amd64/conf/GENERIC](https://github.com/freebsd/freebsd-src/blob/releng/15.0/sys/amd64/conf/GENERIC)
- 版本：[u2f(4): Invert U2F_MAKE_UHID_ALIAS kernel build option](https://github.com/freebsd/freebsd-src/commit/64b530b38be37ebf32596a5ee7ab95f484f49176)，全文近 400 行
...
其曾用名为 `BLOAT_KERNEL_WITH_EXTERR`，用于启用内核扩展错误信息。参见：Extended errors from kernel[EB/OL]. [2026-03-26]. <https://reviews.freebsd.org/D50483>。
...
在内核中包含配置文件 `INCLUDE_CONFIG_FILE`，便于引入更多来自其他文件的选项。
...
smbios，即 System Management BIOS，提供系统管理的基本支持。
...
启用内核 PLL 支持，以使用外部 PPS 信号，并由 ntpd(8) 监控。更多信息请参见 ntpd 文档：Welcome to the home of the Network Time Protocol (NTP) Project.[EB/OL]. [2026-03-26]. <http://www.eecis.udel.edu/~ntp>.
...
> **注意**
>
> 务必保留 `device miibus` 此行，否则上述网卡将无法使用
