> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-2-zhang-freebsd-dao-lun/di-2.1-jie-freebsd-li-xiang-xian-shi-yu-zhong-dao.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-2-zhang-freebsd-dao-lun/di-2.1-jie-freebsd-li-xiang-xian-shi-yu-zhong-dao.md)
...
- 追求软件的稳定性与新颖性，既需具备二进制源，又需支持编译安装。除 FreeBSD 外，鲜有开源系统兼具上述特征（~~Void Linux 还是算了吧~~）。
...
- Jail 与 bhyve 虚拟化不需要额外安装和维护底层虚拟化栈，也无需为每个实例启动完整的操作系统内核和用户空间，节省系统资源。
