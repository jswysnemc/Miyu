> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.5-jie-qi-yong-root-zhang-hu-zhuo-mian-deng-lu.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.5-jie-qi-yong-root-zhang-hu-zhuo-mian-deng-lu.md)
...
2. 分析 SDDM 的 PAM 配置中 `include login` 与 `include system` 的差异，理解后者允许 root 登录的原因。
