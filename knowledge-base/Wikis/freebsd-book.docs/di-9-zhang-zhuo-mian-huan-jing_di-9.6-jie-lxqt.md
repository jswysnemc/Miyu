> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-9-zhang-zhuo-mian-huan-jing/di-9.6-jie-lxqt.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-9-zhang-zhuo-mian-huan-jing/di-9.6-jie-lxqt.md)
...
| `sddm` | 显示管理器 |
| `lxqt` | LXQt 桌面环境 |
| `gvfs` | GNOME 虚拟文件系统，LXQt 需要此组件才能打开 Computer 和 Network，否则会提示 `Operation not supported` |
| `wqy-fonts` | 文泉驿中文字体 |
