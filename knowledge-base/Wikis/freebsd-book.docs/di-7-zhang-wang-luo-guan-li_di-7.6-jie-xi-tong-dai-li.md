> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-7-zhang-wang-luo-guan-li/di-7.6-jie-xi-tong-dai-li.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-7-zhang-wang-luo-guan-li/di-7.6-jie-xi-tong-dai-li.md)
...
- **正向代理（Forward Proxy）**：客户端显式配置代理地址，代理代表客户端向外部服务器发起请求。本节讨论的系统代理即属于正向代理，其典型用途包括突破网络访问限制和缓存加速。
