> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-7-zhang-wang-luo-guan-li/di-7.8-jie-mihomo-pei-zhi.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-7-zhang-wang-luo-guan-li/di-7.8-jie-mihomo-pei-zhi.md)
...
RC 脚本提供了多个命令行参数和配置选项，以下列举常用参数。这些命令会直接将配置写入 **/etc/rc.conf** 文件，如果配置有误，可直接修改对应行。
...
以下为最简配置示例，可在理解其含义后按需修改并写入 **/etc/rc.conf** 文件：

```ini
mihomo_config="https://xxx.yyy" # 实际订阅链接地址，需替换为有效链接
