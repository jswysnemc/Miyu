> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-9-zhang-zhuo-mian-huan-jing/di-9.1-jie-kde-6-zhuo-mian-huan-jing-x11-hui-hua.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-9-zhang-zhuo-mian-huan-jing/di-9.1-jie-kde-6-zhuo-mian-huan-jing-x11-hui-hua.md)

---

# 9.1 KDE 6 桌面环境（X11 会话）

KDE Plasma 是一款易于使用的现代化桌面环境。它提供了一套外观与操作体验一致的应用程序，统一的菜单与工具栏、快捷键、配色方案、本地化支持，以及集中式、对话框驱动的桌面配置工具。
...
修改 **/etc/sysctl.conf** 文件，将其中 `security.bsd.see_other_uids` 的值改为 `1`（`1` 为开启）。重启后即可。
