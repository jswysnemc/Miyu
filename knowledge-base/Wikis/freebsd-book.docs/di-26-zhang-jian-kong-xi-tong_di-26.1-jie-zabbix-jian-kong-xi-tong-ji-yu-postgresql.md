> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-26-zhang-jian-kong-xi-tong/di-26.1-jie-zabbix-jian-kong-xi-tong-ji-yu-postgresql.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-26-zhang-jian-kong-xi-tong/di-26.1-jie-zabbix-jian-kong-xi-tong-ji-yu-postgresql.md)

---

# 26.1 Zabbix 监控系统（基于 PostgreSQL）

Zabbix 是一款企业级分布式开源监控解决方案，可实时监控网络设备、服务器、系统服务及应用软件。本节采用 Ports 方式，基于 PostgreSQL 给出完整安装与配置步骤。
...
zabbix7-frontend 是 Web 控制前端（Zabbix Frontend），提供图形化的监控管理界面。
...
上述安装过程将自动安装 PHP，本节采用的版本为 PHP 8.3（截至撰稿时 PHP 8.4 可能存在兼容性问题）。具体可用版本可查阅 [zabbix7-frontend](https://www.freshports.org/net-mgmt/zabbix7-frontend)，该站点提供最新的包信息与兼容性说明。
...
zabbix7-agent 是 Zabbix 的代理程序，负责在被监控主机上收集监控数据并发送给 Zabbix Server。应安装在需要被监控的服务器上，可部署在多台主机上实现分布式监控。
