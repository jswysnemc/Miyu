> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-3-zhang-freebsd-an-zhuang-ji-chu/di-3.3-jie-shi-yong-vmware-workstation-pro-an-zhuang-freebsd.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-3-zhang-freebsd-an-zhuang-ji-chu/di-3.3-jie-shi-yong-vmware-workstation-pro-an-zhuang-freebsd.md)

---

# 3.3 使用 VMware Workstation Pro 安装 FreeBSD
...
由于默认音量极低，加载声卡后如果仍无声音，请将音量调至 100% 后再确认。
