> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.8-jie-ru-qin-jian-ce-xi-tong.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-18-zhang-an-quan/di-18.8-jie-ru-qin-jian-ce-xi-tong.md)
...
1. 使用 `mtree` 为 **/etc** 目录创建完整性基线，然后人为修改 **/etc/motd** 并添加一名用户，再次运行 `mtree` 检测变更。将检测输出与你的修改操作逐一对应，说明每条检测记录的含义。
