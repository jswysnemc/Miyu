> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-19-zhang-fang-huo-qiang/di-19.1-jie-fang-huo-qiang-gai-shu.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-19-zhang-fang-huo-qiang/di-19.1-jie-fang-huo-qiang-gai-shu.md)
...
FTP 有两种模式：主动模式和被动模式，两者的区别在于如何获取数据通道。被动模式中，数据通道由发起 FTP 会话的客户端获取，因此更为安全。
