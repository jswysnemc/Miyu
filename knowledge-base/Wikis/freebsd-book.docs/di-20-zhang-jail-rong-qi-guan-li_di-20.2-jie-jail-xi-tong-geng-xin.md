> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-20-zhang-jail-rong-qi-guan-li/di-20.2-jie-jail-xi-tong-geng-xin.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-20-zhang-jail-rong-qi-guan-li/di-20.2-jie-jail-xi-tong-geng-xin.md)
...
创建所需 Jail 路径，将基本系统文件放入目录，并将 Ports 树和系统源代码放入模板。注意源代码的版本应与 **/jail/mroot** 对应的基本系统（basejail）版本一致。FreeBSD 源代码可参照相关章节获取：
