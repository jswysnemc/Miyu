> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-17-zhang-zfs-wen-jian-xi-tong/di-17.1-jie-zfs-gai-shu.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-17-zhang-zfs-wen-jian-xi-tong/di-17.1-jie-zfs-gai-shu.md)
...
- Jude A. The History and Future of OpenZFS[EB/OL]. (2020-03)[2026-04-17]. <http://www.allanjude.com/bsd/asiabsdcon2020_history_and_future_of_zfs.pdf>. AsiaBSDCon 2020 演示文稿，明确区分 ZFS-FUSE（该演讲将 LLNL 参与的 ZFS-FUSE 用户态实现界定为 2008 年启动；正文所述 ZFS-FUSE 项目始于 2006 年则为其早期独立开发阶段）与 ZFS on Linux 原生内核模块项目（2010 年由 LLNL 启动）。LLNL, Lawrence Livermore National Laboratory, 劳伦斯利弗莫尔国家实验室。
