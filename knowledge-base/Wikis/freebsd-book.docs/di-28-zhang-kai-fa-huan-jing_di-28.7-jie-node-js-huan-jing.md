> **原文链接：** [https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-28-zhang-kai-fa-huan-jing/di-28.7-jie-node-js-huan-jing.md](https://github.com/FreeBSD-Ask/FreeBSD-Ask/blob/main/di-28-zhang-kai-fa-huan-jing/di-28.7-jie-node-js-huan-jing.md)
...
如果跳过 FreeBSD 基本系统的更新而直接安装软件，就可能遇到以下错误：
...
由于 Ports 会根据当前系统的库版本编译，因此使用 Ports 编译安装不会出现上述问题。
