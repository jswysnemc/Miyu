...
*-u, --ump=version*
Changes the sequencer client to the given MIDI version and outputs via the UMP packets instead of legacy sequencer events. As of now, the only supported version is 1.
