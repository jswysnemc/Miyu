# Content / Manuals / Engine / Daemon / Troubleshoot
...
You may need to edit your environment in files such as `$HOME/.bashrc` or
`$HOME/.profile` to prevent the `DOCKER_HOST` variable from being set erroneously.
