# Content / Manuals / Engine / Daemon / Logs
...
| macOS (Docker Desktop)       | `$HOME/Library/Containers/com.docker.docker/Data/log/vm/init.log`                                                                            |
...
```console
$ grep '"component":"dockerd"' $HOME/Library/Containers/com.docker.docker/Data/log/vm/init.log
```
