# Content / Manuals / Compose / Install / Linux
...
1.  To download and install the Docker Compose CLI plugin, run:
    ...
    To install:
    - Docker Compose for _all users_ on your system, replace `$HOME/.docker/cli-plugins` with `/usr/local/lib/docker/cli-plugins`.
