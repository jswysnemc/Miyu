...
DESCRIPTION
     lvdisplay  shows the attributes of LVs, like size, read/write status, snap‐
     shot information, etc.

     lvs(8) is a preferred alternative that shows the same information and more,
...
OPTIONS
     ...
     -a|--all
            Show information about internal LVs.  These are components of normal
            LVs, such as mirrors, which are not independently  accessible,  e.g.
            not mountable.
     ...
     -c|--colon
            ...
            programs.  Also see lvs(8) which provides considerably more  control
     ...
     -H|--history
            ...
            LVs were removed while lvm.conf(5)  metadata/record_lvs_history  was
            enabled.)
...
Red Hat, Inc.                  LVM TOOLS #VERSION#                  LVDISPLAY(8)
```
