...
DESCRIPTION
     ...
     pvs(8) is a preferred alternative that shows the same information and more,
...
OPTIONS
     ...
     -c|--colon
            ...
            programs.  Also see pvs(8) which provides considerably more  control
     ...
     -C|--columns
            Display  output  in  columns.   The  equivalent  of pvs(8).  Options
            listed are the same as options given in pvs(8).
...
Red Hat, Inc.                  LVM TOOLS #VERSION#                  PVDISPLAY(8)
```
