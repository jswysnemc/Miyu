...
DESCRIPTION
     ...
     Repeat the force option (-ff) to forcibly remove a PV belonging to  an  ex‐
     isting VG. Normally, vgreduce(8) should be used instead.
...
Red Hat, Inc.                  LVM TOOLS #VERSION#                   PVREMOVE(8)
```
