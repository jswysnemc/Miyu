...
**type** =
**integer**\|**float**\|**string** **integer** = \[**0**-**9**\]\*
**float** = \[**0**-**9**\]\*'**.**'\[**0**-**9**\]\*
**string** = '**"**' .\* '**"**'
