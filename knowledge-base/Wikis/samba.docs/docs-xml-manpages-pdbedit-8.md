...
-P\|--account-policy=STRING

-C\|--value=LONG

-c\|--account-control=STRING
...
> [!NOTE]
> pdbedit does not call the unix password synchronization script if has been set. It only updates the data in the Samba user database.
>
