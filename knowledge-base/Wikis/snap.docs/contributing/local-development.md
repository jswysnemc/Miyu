...
This page outlines the different ways in which you can contribute to the Snap
...
- [Find an issue to work on](https://snapcraft.io/docs/contributing/local-development/)
- [Pick your workflow](https://snapcraft.io/docs/contributing/local-development/)
- [Test your contribution](https://snapcraft.io/docs/contributing/local-development/)
- [Submit it for review](https://snapcraft.io/docs/contributing/local-development/)

## Find issues to work on

We use GitHub issues to track documentation tasks. Start by
[checking our issues list](https://github.com/canonical/snap-docs/issues)
to see if there are any tasks you'd like to work on.

You can see which issues are unassigned by selecting
"Assigned to nobody" from the "Assignee" drop-down menu (or [use this link](https://github.com/canonical/snap-docs/issues?q=is%3Aissue+is%3Aopen+no%3Aassignee) as
a shortcut).
...
* **Direct edits via GitHub web interface**: For simple changes like typos or
  ...
  [quickstart guide](https://snapcraft.io/docs/contributing/local-development/).

* **Local development**: For more substantial or complex changes, for example to
  multiple pages, continue with [Local development](https://snapcraft.io/docs/contributing/local-development/).
...
Create your own fork of the [Snap documentation GitHub repository](https://github.com/canonical/snap-docs).
...
commands to `snap-docs`!

### Get the documentation

In your terminal, clone the Snap documentation repository by running:

```bash
git clone git@github.com:canonical/snap-docs.git
```

This creates a new folder on your machine called
`snap-docs` containing the contents of this repository.
...
against the Snap documentation repository and fill in the pull request
template.
...
After you have submitted your PR, one of the Snap documentation maintainers
...
One or more of the Snap team maintainers will review the changes you
