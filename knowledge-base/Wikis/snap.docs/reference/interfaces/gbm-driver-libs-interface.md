...
https://github.com/canonical/snapd/blob/master/interfaces/builtin/gbm_driver_libs_test.go

The source code for the interface is in the snapd repository:

https://github.com/canonical/snapd/blob/master/interfaces/builtin/gbm_driver_libs.go
