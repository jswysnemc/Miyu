...
| Permissions |  |  |
|--|--|--|
| **[Auto-connect](https://snapcraft.io/docs/explanation/interfaces/interface-auto-connection/)** | **no** by default | **yes** with snaps from the same publisher |
| **[Super-privileged](https://snapcraft.io/docs/explanation/interfaces/super-privileged-interfaces/)** | **no** for plugs | **yes** for slots |

**Attributes**:

 * **`posix-mq`** (slot and plug)
