...
To mount a local filesystem, `mount-control` must be used together with the [block-devices interface](https://snapcraft.io/docs/reference/interfaces/block-devices-interface/).
...
- an accompanying [snapctl mount](https://snapcraft.io/docs/how-to-guides/snap-development/use-snapctl/)
