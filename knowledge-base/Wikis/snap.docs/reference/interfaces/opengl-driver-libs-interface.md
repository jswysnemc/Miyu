...
https://github.com/canonical/snapd/blob/master/interfaces/builtin/opengl_driver_libs_test.go

The source code for the interface is in the snapd repository:

https://github.com/canonical/snapd/blob/master/interfaces/builtin/opengl_driver_libs.go
