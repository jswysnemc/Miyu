...
See [Assertions](https://snapcraft.io/docs/explanation/security/assertions/) for more details.
...
See [Branches](https://snapcraft.io/docs/explanation/how-snaps-work/channels-and-tracks/) for more details.

### brand store

See [Dedicated Snap Store](https://snapcraft.io/docs/reference/glossary/)
...
See [Channels](https://snapcraft.io/docs/explanation/how-snaps-work/channels-and-tracks/) for more details.
...
See [Snap confinement](https://snapcraft.io/docs/explanation/security/snap-confinement/) for more details.
...
See [The gadget snap](https://snapcraft.io/docs/reference/development/yaml-schemas/the-gadget-snap/) for more details.
...
For more details, see [Supported snap hooks](https://snapcraft.io/docs/reference/development/supported-snap-hooks/).
...
See [Interfaces](https://snapcraft.io/docs/explanation/interfaces/all-about-interfaces/) and [Interface management](https://snapcraft.io/docs/how-to-guides/manage-snaps/connect-interfaces/) for more details.
...
See [Parallel installs](https://snapcraft.io/docs/explanation/how-snaps-work/parallel-installs/) for more information.
...
A platform snap cannot be installed directly by users. They are instead invoked by snap developers as the `default-provider` in a [content interface](https://snapcraft.io/docs/reference/interfaces/content-interface/).
...
See [How to manage updates](https://snapcraft.io/docs/how-to-guides/manage-snaps/manage-updates/) for further details.
...
A snap's *revision* is a number assigned by the [Snap Store](https://snapcraft.io/docs/reference/glossary/) automatically to give each snap a unique identity within and across its channels.
...
See [Revisions](https://snapcraft.io/docs/explanation/how-snaps-work/revisions/) for further details.
...
See [Getting started](https://snapcraft.io/docs/tutorials/get-started/) for more details.
...
See [Snapshots](https://snapcraft.io/docs/how-to-guides/manage-snaps/create-data-snapshots/) for further details.
...
See [Tracks](https://snapcraft.io/docs/explanation/how-snaps-work/channels-and-tracks/) for more details.

### Transitional interface

A _transitional interface_ is an [interface](https://snapcraft.io/docs/explanation/interfaces/all-about-interfaces/) that can be used by a trusted snap to access traditional Linux desktop environments that were not designed to integrate with [snap confinement](https://snapcraft.io/docs/explanation/security/snap-confinement/). These interfaces will become deprecated as replacement or modified technologies that enforce strong application isolation become available.
