...
System usernames can be used by snap developers to enable them to [control services](https://snapcraft.io/docs/how-to-guides/manage-snaps/control-services/) as a user other than the default `root`.
...
Since the [process-control](https://snapcraft.io/docs/reference/interfaces/process-control-interface/) interface grants considerable access for system-wide process management, best practice dictates that privileges _must_ be dropped as needed when sending signals to other processes in the snap.
