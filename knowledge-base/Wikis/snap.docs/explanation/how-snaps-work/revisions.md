...
A snap's *revision* is a number assigned automatically by the [Snap Store](https://snapcraft.io/docs/reference/glossary/) with each snap upload, giving each snap binary a unique identity within, and across, its [channels](https://snapcraft.io/docs/explanation/how-snaps-work/channels-and-tracks/).
...
The store caches several older revisions of every snap, as does the local system. By default, 2 revisions are stored locally, while Ubuntu Core systems store 3. These defaults can be changed with the [refresh-retain](https://snapcraft.io/docs/how-to-guides/manage-snaps/manage-updates/) system option.
...
The revision identity is used as a reference for revision-specific data. As described in [Data locations](https://snapcraft.io/docs/reference/administration/data-locations/), revision-specific data for a snap is stored in a either system-wide location, or a user-specific home location:
...
Revision-specific directories are retained inline with the [refresh-retain](https://snapcraft.io/docs/how-to-guides/manage-snaps/manage-updates/) system option.

Other than the contents of the common directories, a [Snapshot](https://snapcraft.io/docs/how-to-guides/manage-snaps/create-data-snapshots/) stores only the data associated with the currently installed revision. See [What a snapshot stores](https://snapcraft.io/docs/how-to-guides/manage-snaps/create-data-snapshots/) for more details.
