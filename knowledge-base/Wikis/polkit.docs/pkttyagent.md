...
To get notified when the authentication agent has been registered either listen to the [Changed](#eggdbus-signal-org.freedesktop.PolicyKit1.Authority::Changed) D-Bus signal or use `--notify-fd` to pass the number of a file descriptor that has been passed to the program. This file descriptor will then be closed when the authentication agent has been successfully registered.
...
[`polkit(8)`](#polkit.8), [`polkitd(8)`](#polkitd.8), [`pkaction(1)`](#pkaction.1), [`pkcheck(1)`](#pkcheck.1), [`pkexec(1)`](#pkexec.1)
