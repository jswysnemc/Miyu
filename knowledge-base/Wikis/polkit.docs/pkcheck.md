...
Octets that are not in \[a-zA-Z0-9\_\] are escaped using octal codes prefixed with *\\*. For example, the UTF-8 string *føl,你好* will be printed as *f\303\270l\54\344\275\240\345\245\275*.
...
[`polkit(8)`](#polkit.8), [`polkitd(8)`](#polkitd.8), [`pkaction(1)`](#pkaction.1), [`pkexec(1)`](#pkexec.1), [`pkttyagent(1)`](#pkttyagent.1)
