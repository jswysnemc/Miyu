...
- `0x00` -- No abort
- `0x01` -- Aborted by local Host or remote request
- `0x02` -- No CSSYNC (Mode 0) received
...
The step data following the subevent header uses the same mode-specific format as HCI CS Subevent Result events (Mode 0--3), described in the [CS Step Modes](#cs-step-modes) section above.
