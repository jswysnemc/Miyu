...
Object path
freely definable (Server role) \[variable prefix\]/{hci0,hci1,...}/[dev](){BDADDR}/sep# (Client role)
...
See [MediaEndpoint Properties](#mediaendpoint-properties) for their possible values.
...
See [SetConfiguration](#SetConfiguration) for their possible values.
...
##### uint32t Vendor \[readonly, Optional\]
