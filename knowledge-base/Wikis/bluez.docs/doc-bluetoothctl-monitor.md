...
Each pattern requires 3 arguments: \<startposition\> \<addata_type\> \<contentof_pattern\> Multiple patterns can be specified to create an OR condition.
...
Uses
**org.bluez.AdvertisementMonitorManager(5)** properties
