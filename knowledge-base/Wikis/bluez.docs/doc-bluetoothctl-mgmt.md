...
\[-t type\]
Optional address type (public, random, lepublic, lerandom)
...
\[-t type\]
Address type (public, random, lepublic, lerandom)
...
:\<source\>:\<vendor\>:\<product\>:\<version\>: Device ID in format source:vendor:product:version (all hexadecimal) :Example Set USB source with Linux Foundation vendor ID: \| **\> did 0x0002:0x1D6B:0x0001:0x0100** :Example Set USB device with Cypress vendor ID: \| **\> did 0x0002:0x04B4:0x1234:0x0200** :Example Set Bluetooth SIG source with Broadcom vendor: \| **\> did 0x0001:0x000F:0x0001:0x0100** :Example Set Bluetooth SIG source with Apple vendor: \| **\> did 0x0001:0x004C:0x0001:0x0100** :Example Set custom USB device ID: \| **\> did 0x0002:0xFFFF:0x1234:0x5678** :Example Set Qualcomm Bluetooth device: \| **\> did 0x0001:0x05F1:0xABCD:0x0001**
