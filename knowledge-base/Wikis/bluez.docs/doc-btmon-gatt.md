...
1.  **Primary Service Discovery** -- Find all primary services and their handle ranges.
2.  **Secondary Service Discovery** -- Find any secondary (included-only) services.
3.  **Included Service Discovery** -- Find which services include other services.
4.  **Characteristic Discovery** -- Find all characteristics within each service.
5.  **Descriptor Discovery** -- Find all descriptors for each characteristic.
6.  **Characteristic Value Reading** -- Read the values of readable characteristics.
