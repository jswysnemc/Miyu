...
bluetoothctl
\> endpoint.register \<UUID\> \<codec\[:company\]\> \[capabilities...\]
...
bluetoothctl
\> endpoint.unregister \<UUID/object\>
...
Register endpoints an player objects within root object which must implement **org.freedesktop.DBus.ObjectManager**.
...
> Bluetooth TX timestamping in media stream sockets is supported by BlueZ and kernel. Applications may check kernel support for specific timestamp types via SIOCETHTOOL.
