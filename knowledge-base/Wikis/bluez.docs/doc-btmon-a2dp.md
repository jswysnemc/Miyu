...
1.  Find L2CAP Connection Request for PSM 25 -- confirms AVDTP channel setup
2.  Find Discover response -- shows available endpoints and whether any are already in use
...
8.  If audio cuts out, look for Suspend or Close, or check for ACL disconnection
