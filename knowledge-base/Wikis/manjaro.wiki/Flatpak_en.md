[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Flatpak&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=Flatpak "Flatpak (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Flatpak/tr "Flatpak (8% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=Flatpak/fr "Flatpak (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Flatpak/ru "Flatpak (100% translated)") • ‎[فارسی](//wiki.manjaro.org/index.php?title=Flatpak/fa "فِلَت‌پَک (94% translated)")
