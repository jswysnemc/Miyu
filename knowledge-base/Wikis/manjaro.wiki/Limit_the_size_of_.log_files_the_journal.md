...
[English] • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Limit_the_size_of_.log_files_%26_the_journal/tr ".log dosyalarının ve günlüğün boyutunu sınırlayın (1% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Limit_the_size_of_.log_files_%26_the_journal/ru "Ограничение размера файлов .log и журнала (100% translated)")
