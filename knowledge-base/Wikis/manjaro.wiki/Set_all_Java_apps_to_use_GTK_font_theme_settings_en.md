[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Set+all+Java+apps+to+use+GTK%2B+font+%26+theme+settings&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=Set_all_Java_apps_to_use_GTK%2B_font_%26_theme_settings "Set all Java apps to use GTK+ font & theme settings (100% translated)") • ‎[español](//wiki.manjaro.org/index.php?title=Set_all_Java_apps_to_use_GTK%2B_font_%26_theme_settings/es "Configure todas las aplicaciones Java para usar la configuración de fuente y tema GTK+ (100% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=Set_all_Java_apps_to_use_GTK%2B_font_%26_theme_settings/fr "Configurer toutes les applications Java pour qu'elles utilisent les polices et les thèmes GTK (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Set_all_Java_apps_to_use_GTK%2B_font_%26_theme_settings/ru "Настройка всех Java-приложений на использование шрифтов и тем GTK+ (100% translated)") • ‎[فارسی](//wiki.manjaro.org/index.php?title=Set_all_Java_apps_to_use_GTK%2B_font_%26_theme_settings/fa "تنظیم همهٔ برنامه‌های جاوا برای استفاده از قلم و زمینهٔ +GTK (83% translated)")
