[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-KDE&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=KDE "KDE (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=KDE/tr "KDE (3% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=KDE/ru "KDE (100% translated)") • ‎[فارسی](//wiki.manjaro.org/index.php?title=KDE/fa "کِی‌دی‌ئی (KDE) (21% translated)")
