This page contains [[changes](//wiki.manjaro.org/index.php?title=ALSA&oldid=23553&diff=52162)] which are not marked for translation.

Other languages:

[English] • ‎[Türkçe](//wiki.manjaro.org/index.php?title=ALSA/tr "ALSA (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=ALSA/ru "ALSA (100% translated)") • ‎[فارسی](//wiki.manjaro.org/index.php?title=ALSA/fa "معمار صوتی پیشرفته لینوکس (ALSA) (8% translated)")
