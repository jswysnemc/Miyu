[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Aliases+in+.bashrc&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=Aliases_in_.bashrc "Aliases in .bashrc (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Aliases_in_.bashrc/tr ".bashrc'deki takma adlar (100% translated)") • ‎[português do Brasil](//wiki.manjaro.org/index.php?title=Aliases_in_.bashrc/pt-br "Aliases no .bashrc (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Aliases_in_.bashrc/ru "Альясы в .bashrc (100% translated)")
