[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Using+Compton+for+a+tear-free+experience+in+Xfce&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=Using_Compton_for_a_tear-free_experience_in_Xfce "Using Compton for a tear-free experience in Xfce (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Using_Compton_for_a_tear-free_experience_in_Xfce/tr "Xfce'de yırtılmasız bir deneyim için Compton'u kullanma (29% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=Using_Compton_for_a_tear-free_experience_in_Xfce/fr "Utiliser Compton pour une navigation libre de déchirures d'écran sur Xfce (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Using_Compton_for_a_tear-free_experience_in_Xfce/ru "Использование Compton для работы без разрывов в Xfce (100% translated)")
