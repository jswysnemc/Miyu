[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Forum+Rules&language=en&action=page&filter= "Special:Translate")

Other languages:

[Deutsch](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Forum+Rules&language=de&task=view "Start translation for this language") • ‎[English](//wiki.manjaro.org/index.php?title=Forum_Rules "Forum Rules (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Forum_Rules/tr "Forum Kuralları (2% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Forum_Rules/ru "Правила форума (100% translated)")

## Contents

-   [[1] [Manjaro Linux Forum Rules of Engagement]](#Manjaro_Linux_Forum_Rules_of_Engagement)
-   [[2] [Common Sense Introduction]](#Common_Sense_Introduction)
-   [[3] [Legality]](#Legality)
-   [[4] [How to Post]](#How_to_Post)
-   [[5] [Personal Topics/Rants]](#Personal_Topics.2FRants)
-   [[6] [Ineffective Discussion (\"Bikeshed\")]](#Ineffective_Discussion_.28.22Bikeshed.22.29)
-   [[7] [Be Responsible]](#Be_Responsible)
-   [[8] [Respect Other Users]](#Respect_Other_Users)
-   [[9] [Respect Other Distributions and Operating Systems]](#Respect_Other_Distributions_and_Operating_Systems)
-   [[10] [Pasting code and log file contents]](#Pasting_code_and_log_file_contents)
-   [[11] [Product Recommendation Requests]](#Product_Recommendation_Requests)
-   [[12] [Spam/Advertising/Solicitation]](#Spam.2FAdvertising.2FSolicitation)
-   [[13] [Homework]](#Homework)
-   [[14] [Old Threads/\"Necro-Bumping\"]](#Old_Threads.2F.22Necro-Bumping.22)
-   [[15] [Forum Member Accounts]](#Forum_Member_Accounts)
-   [[16] [Impersonation]](#Impersonation)
-   [[17] [No Trolling]](#No_Trolling)
-   [[18] [Bigotry & Personal Attacks]](#Bigotry_.26_Personal_Attacks)
-   [[19] [Controversy]](#Controversy)
-   [[20] [Safe For Work]](#Safe_For_Work)
-   [[21] [No Power-Posting/Empty Posts]](#No_Power-Posting.2FEmpty_Posts)
-   [[22] [Life is a Two-way Street]](#Life_is_a_Two-way_Street)
-   [[23] [Bumping]](#Bumping)
-   [[24] [Cross-Posting]](#Cross-Posting)
-   [[25] [Support for other platforms]](#Support_for_other_platforms)
-   [[26] [Misplaced Posts]](#Misplaced_Posts)
-   [[27] [Thread Hijacking]](#Thread_Hijacking)
-   [[28] [Posting Personal Contact Information]](#Posting_Personal_Contact_Information)
-   [[29] [Respect The Staff]](#Respect_The_Staff)
-   [[30] [Warnings, User Locking, Banning]](#Warnings.2C_User_Locking.2C_Banning)
    -   [[30.1] [Forum Rules Violations]](#Forum_Rules_Violations)
-   [[31] [Freedom]](#Freedom)
-   [[32] [Caveat]](#Caveat)
-   [[33] [Suggested Further Reading]](#Suggested_Further_Reading)
-   [[34] [Quality information. No AI generated posts]](#Quality_information._No_AI_generated_posts)

## [Manjaro Linux Forum Rules of Engagement]

These rules have been adopted from the [Arch Linux Forum etiquette page](https://wiki.archlinux.org/index.php/Forum_etiquette) that can be found in the [Arch Wiki](https://wiki.archlinux.org/). These guidelines have been developed over time and are based on the extensive experience of the [Arch Linux](https://www.archlinux.org/) moderation team with input by the Arch community. As with Arch\'s high quality packages, we also use their high quality forum rules for a base.
...
Do not post on the Arch forums. Those forums are for Arch users **only**.

When seeking help:

-   Please seek a solution yourself by researching in the [Manjaro wiki](https://wiki.manjaro.org/), [Manjaro Forum](https://forum.manjaro.org). Another important source of information is the [Arch Wiki](https://wiki.archlinux.org/) and the [Arch Forums](https://bbs.archlinux.org/).
...
**[Criminal solicitation](http://definitions.uslegal.com/c/criminal-solicitation/) is strictly forbidden.**
...
-   Further reading: [How To Ask Questions The Smart Way](http://www.catb.org/~esr/faqs/smart-questions.html)
...
## [][Ineffective Discussion ([\"Bikeshed\"](http://www.freebsd.org/doc/en/articles/mailing-list-faq/bikeshed.html))]
...
-   Please use \[code\] tags when pasting console snippets.
-   Please use a [pastebin service](https://wiki.archlinux.org/title/List_of_applications/Internet#Pastebin_services) when posting large amounts of code or long logs.
...
-   However, Manjaro partners with several hardware vendors. If you\'re interested in hardware powered by Manjaro, you are welcome to check out the available options at the bottom of the [Manjaro Products](https://manjaro.org/products) page.
...
-   Multiple forum accounts is strictly forbidden.
-   Having multiple accounts is an unnecessary use of resources. Further, it may be interpreted as trolling behavior.
-   Sockpuppets are strictly forbidden.
...
\"Flaming\" fellow members (including the Manjaro team) will not be tolerated. Never resort to simple insults and please avoid sarcastic and patronizing language. *Discussions can be productive, but quarrelling is usually destructive.* Any form of bigotry pertaining to **ethnicity (nationality), religion, gender** or **sexual preference** is prohibited. Personal attacks (substituting abusive remarks for evidence when attacking another person\'s comments) are not acceptable and some disciplinary action may be taken.
...
-   Images of graphic violence or nudity are prohibited.
...
**\*off topic** - not on the topic of discussion; far from the general subject of a discussion; not part of the purpose of a particular communication channel, such as an Internet newsgroup.[\[1\]](http://idioms.thefreedictionary.com/off+topic)
...
Never argue with a moderator on the forum. Contact them via PM. If unsatisfied with their response, contact another moderator or Core team member. Do not contact Philm since he does not deal with forum moderation.

If you feel that an egregious oversight has been made, do NOT post complaints in forum threads - they will be quickly closed. Alternatively, use the forum report function or message a member of the Global Moderators group.
...
1.  First violation prompts a formal warning.
2.  Second & final warning, often accompanied by a short-term suspension of account.
3.  The forum member will be banned.
...
The free and open exchange of assistance, speech, ideas and opinions is highly regarded and encouraged on the forums, but it must be noted that the freedom granted to forum members is relative freedom.

It exists within the boundaries of the above guidelines and principles. Complaints of censorship are therefore baseless and unfounded, since this necessary framework must simultaneously provide reasonable limitations.

To illustrate, we are aware of the physical laws which govern energy and matter, yet we do not complain of their oppression. Instead, we recognize that such laws are essential for our welfare.

Likewise, the Manjaro community\'s high standards reflected in these guidelines regulate community freedom for the common good and protection of all. The key, then, to true freedom on the forums is to cultivate benevolence toward others and harmonize our attitude with the Manjaro Way by bringing only benefit to our peers.

In addition, this allows members to satisfy all contributive impulses without aggravating themselves or encroaching on the freedom of others.

Embracing the above principles and obeying the forum guidelines therefore benefits the entire community by providing freedom from the harmful and negative consequences of a more chaotic approach.

## [Caveat]

-   These rules are subject to change and addition without notice.
-   Any modification to the Manjaro forum rules may be applied retroactively to any and all posts without notice.

## [Suggested Further Reading]

How to Disagree by Paul Graham - [http://www.paulgraham.com/disagree.html](http://www.paulgraham.com/disagree.html)

## [Quality information. No AI generated posts]

In a community oriented software project like Manjaro, we want to provide quality information. Therefore we expect everybody to verify their proposals or make it clear that it\'s a guess. That\'s why a post generated by an AI and not verified by the poster has to be considered inaccurate and will be deleted. The poster will be warned one time and removed from the forum next time. If you verified a proposal from an AI yourself the you can also write the post in your own words.