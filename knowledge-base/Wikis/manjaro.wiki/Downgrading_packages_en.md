[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Downgrading+packages&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=Downgrading_packages "Downgrading packages (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Downgrading_packages/tr "Paketlerin sürümünü düşürme (4% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=Downgrading_packages/fr "Rétrogradation de paquets (88% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Downgrading_packages/ru "Понижение версии пакетов (100% translated)")
