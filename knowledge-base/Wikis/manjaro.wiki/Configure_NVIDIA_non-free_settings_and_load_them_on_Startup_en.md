[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Configure+NVIDIA+%28non-free%29+settings+and+load+them+on+Startup&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=Configure_NVIDIA_(non-free)_settings_and_load_them_on_Startup "Configure NVIDIA (non-free) settings and load them on Startup (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Configure_NVIDIA_(non-free)_settings_and_load_them_on_Startup/ru "Настройка параметров NVIDIA (несвободные) и загрузка их при запуске (100% translated)")
