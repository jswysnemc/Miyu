[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-LXQt+with+kwin&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=LXQt_with_kwin "LXQt with kwin (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=LXQt_with_kwin/tr "kwin ile LXQt (10% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=LXQt_with_kwin/ru "LXQt с kwin (100% translated)")
