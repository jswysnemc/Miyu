...
[English] • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Basic_Submission_Rules/tr "Temel Gönderim Kuralları (20% translated)") • ‎[español](//wiki.manjaro.org/index.php?title=Basic_Submission_Rules/es "Reglas básicas de presentación (100% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=Basic_Submission_Rules/fr "Règles de base de la soumission (100% translated)") • ‎[português do Brasil](//wiki.manjaro.org/index.php?title=Basic_Submission_Rules/pt-br "Regras Básicas de Submissão (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Basic_Submission_Rules/ru "Основные правила подачи заявок (100% translated)") • ‎[中文（中国大陆）‎](//wiki.manjaro.org/index.php?title=Basic_Submission_Rules/zh-cn "基本的提交规则 (100% translated)")

## Contents

-   [[1] [Overview]](#Overview)
-   [[2] [How to Create an Account]](#How_to_Create_an_Account)
-   [[3] [Do]](#Do)
-   [[4] [Don\'t]](#Don.27t)
...
To request a Manjaro Wiki account, send an email to [our support](mailto:support@manjaro.org).
