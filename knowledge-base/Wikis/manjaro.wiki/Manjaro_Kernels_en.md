[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Manjaro+Kernels&language=en&action=page&filter= "Special:Translate")

Other languages:

[Deutsch](//wiki.manjaro.org/index.php?title=Manjaro_Kernels/de "Manjaro Kernel (67% translated)") • ‎[English](//wiki.manjaro.org/index.php?title=Manjaro_Kernels "Manjaro Kernels (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Manjaro_Kernels/tr "Manjaro Çekirdekleri (4% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=Manjaro_Kernels/fr "Noyaux (kernels) Manjaro (30% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Manjaro_Kernels/ru "Ядра Manjaro (100% translated)") • ‎[עברית](//wiki.manjaro.org/index.php?title=Manjaro_Kernels/he "Manjaro Kernels/he (4% translated)")
