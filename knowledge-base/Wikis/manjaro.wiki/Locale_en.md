[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Locale&language=en&action=page&filter= "Special:Translate")

Other languages:

[English](//wiki.manjaro.org/index.php?title=Locale "Locale (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Locale/tr "Yerel ayar (14% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Locale/ru "Языковые пакеты (100% translated)")
