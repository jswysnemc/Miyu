[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Pacman+Overview&language=en&action=page&filter= "Special:Translate")

Other languages:

[Deutsch](//wiki.manjaro.org/index.php?title=Pacman_Overview/de "Pacman Übersicht (90% translated)") • ‎[English](//wiki.manjaro.org/index.php?title=Pacman_Overview "Pacman Overview (100% translated)") • ‎[español](//wiki.manjaro.org/index.php?title=Pacman_Overview/es "Descripción de Pacman (98% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=Pacman_Overview/fr "Aperçu de Pacman (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Pacman_Overview/ru "Обзор Pacman (100% translated)") • ‎[中文](//wiki.manjaro.org/index.php?title=Pacman_Overview/zh "Pacman总览 (6% translated)") • ‎[中文（中国大陆）‎](//wiki.manjaro.org/index.php?title=Pacman_Overview/zh-cn "Pacman 简介 (36% translated)")
...
\
To force a full refresh of the package database and update all packages on the system. It may necessary when [switching branches](//wiki.manjaro.org/index.php?title=Special:MyLanguage/Switching_Branches "Special:MyLanguage/Switching Branches") or [switching mirrors](//wiki.manjaro.org/index.php?title=Special:MyLanguage/Pacman-mirrors "Special:MyLanguage/Pacman-mirrors") to avoid inconsistent metadata. Inconsistent metadata will be obvious if you get **404 Not Found** for certain packages.
