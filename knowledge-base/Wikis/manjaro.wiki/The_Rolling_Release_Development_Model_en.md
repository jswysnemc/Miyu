[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-The+Rolling+Release+Development+Model&language=en&action=page&filter= "Special:Translate")

Other languages:

[Deutsch](//wiki.manjaro.org/index.php?title=The_Rolling_Release_Development_Model/de "Das Entwicklungsmodel "Rolling Release" (80% translated)") • ‎[English](//wiki.manjaro.org/index.php?title=The_Rolling_Release_Development_Model "The Rolling Release Development Model (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=The_Rolling_Release_Development_Model/tr "Sürekli Güncelleme Geliştirme Modeli (100% translated)") • ‎[español](//wiki.manjaro.org/index.php?title=The_Rolling_Release_Development_Model/es "El modelo de lanzamiento continuo (80% translated)") • ‎[français](//wiki.manjaro.org/index.php?title=The_Rolling_Release_Development_Model/fr "Le modèle de développement en mise à jour continue (Rolling Release) (100% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=The_Rolling_Release_Development_Model/ru "Модель разработки Rolling Release (100% translated)") • ‎[فارسی](//wiki.manjaro.org/index.php?title=The_Rolling_Release_Development_Model/fa "طرح توسعهٔ انتشار غلتان (100% translated)")

## Contents

-   [[1] [What are the advantages of a rolling model?]](#What_are_the_advantages_of_a_rolling_model.3F)
-   [[2] [What are the disadvantages of a rolling release model?]](#What_are_the_disadvantages_of_a_rolling_release_model.3F)
-   [[3] [Why are new versions of Manjaro being released?]](#Why_are_new_versions_of_Manjaro_being_released.3F)
-   [[4] [Why are new releases given version numbers?]](#Why_are_new_releases_given_version_numbers.3F)
