[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Using+Manjaro+for+Windows+users&language=en&action=page&filter= "Special:Translate")
