[Translate this page](//wiki.manjaro.org/index.php?title=Special:Translate&group=page-Systemd-boot&language=en&action=page&filter= "Special:Translate")

Other languages:

[Deutsch](//wiki.manjaro.org/index.php?title=Systemd-boot/de "Systemd-boot (62% translated)") • ‎[English](//wiki.manjaro.org/index.php?title=Systemd-boot "Systemd-boot (100% translated)") • ‎[Türkçe](//wiki.manjaro.org/index.php?title=Systemd-boot/tr "Systemd-boot (15% translated)") • ‎[русский](//wiki.manjaro.org/index.php?title=Systemd-boot/ru "Systemd-boot (100% translated)")
