...
-   [[1] [Why this article is outdated]](#Why_this_article_is_outdated)
-   [[2] [Where to find updated information]](#Where_to_find_updated_information)
-   [[3] [Introduction]](#Introduction)
-   [[4] [Overview]](#Overview)
-   [[5] [Detailed Guide]](#Detailed_Guide)
    -   [[5.1] [Dealing with Overlays]](#Dealing_with_Overlays)
    -   [[5.2] [Remove emul-linux and all dependencies]](#Remove_emul-linux_and_all_dependencies)
    -   [[5.3] [Apply the abi_x86_32 flag]](#Apply_the_abi_x86_32_flag)
    -   [[5.4] [Update the System]](#Update_the_System)
    -   [[5.5] [GNU Compiler Collection special case]](#GNU_Compiler_Collection_special_case)
    -   [[5.6] [Dead END]](#Dead_END)
...
Read the [Project page](https://wiki.gentoo.org/wiki/Project:Multilib/Concepts "Project:Multilib/Concepts")
...
[FILE] **`/etc/portage/package.use`Setting abi_x86_32**
...
[FILE] **`/etc/portage/package.use`Setting abi_x86_32 for wine**
...
[FILE] **`/etc/portage/package.use`Setting additional abi_x86_32 flags - EXAMPLE**
