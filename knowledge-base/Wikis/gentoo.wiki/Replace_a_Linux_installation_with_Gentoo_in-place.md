...
-   [[1] [Prepare the system]](#Prepare_the_system)
-   [[2] [Overwrite root with Gentoo]](#Overwrite_root_with_Gentoo)
-   [[3] [Bring the Gentoo system to a bootable state]](#Bring_the_Gentoo_system_to_a_bootable_state)
-   [[4] [Remove anything that was left behind by the previous OS]](#Remove_anything_that_was_left_behind_by_the_previous_OS)
...
`root `[`#`]`wget -P /tmp `[`ftp://files.gentoo.gr/releases/amd64/current-iso/stage3-amd64-\*.tar.bz2`](ftp://files.gentoo.gr/releases/amd64/current-iso/stage3-amd64-\*.tar.bz2)` `
