[] This article is a [stub](https://wiki.gentoo.org/wiki/Category:Stub "Category:Stub"). Please help out by [expanding it](https://wiki.gentoo.org/index.php?title=Dcfldd&action=edit) - [how to get started](https://wiki.gentoo.org/wiki/Gentoo_Wiki:Contributor%27s_guide "Gentoo Wiki:Contributor's guide").

**Resources**

[[]][Home](http://dcfldd.sourceforge.net/)

[[]][Package information](https://packages.gentoo.org/packages/sys-apps/dcfldd)

[dcfldd] is an enhanced [[dd](https://wiki.gentoo.org/wiki/Dd "Dd")] tool that includes additional features for forensics and security.
...
Install the [[[sys-apps/dcfldd]](https://packages.gentoo.org/packages/sys-apps/dcfldd)[]] package:
