...
-   [[1] [Install Required Additional Packages]](#Install_Required_Additional_Packages)
-   [[2] [Verify Utilities for LDP Documentation]](#Verify_Utilities_for_LDP_Documentation)
-   [[3] [Importing Tex files into Lyx]](#Importing_Tex_files_into_Lyx)
...
[CODE]
    ...
    [ebuild  NS    ] app-text/docbook-sgml-dtd-4.1-r3:4.1 [3.0-r3:3.0, 3.1-r3:3.1, 4.4:4.4] 56 kB
...
[http://www.tldp.org/HOWTO/DocBook-Install](http://www.tldp.org/HOWTO/DocBook-Install)