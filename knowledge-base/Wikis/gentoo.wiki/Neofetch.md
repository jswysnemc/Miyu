[] This article is a [stub](https://wiki.gentoo.org/wiki/Category:Stub "Category:Stub"). Please help out by [expanding it](https://wiki.gentoo.org/index.php?title=Neofetch&action=edit) - [how to get started](https://wiki.gentoo.org/wiki/Gentoo_Wiki:Contributor%27s_guide "Gentoo Wiki:Contributor's guide").

**Resources**

[[]][GitHub](https://github.com/dylanaraps/neofetch)

[[]][Package information](https://packages.gentoo.org/packages/app-misc/neofetch)

**Neofetch** is a command-line system information tool that displays information about the operating system, software, and hardware in an aesthetic and visually pleasing way. Neofetch is written in bash 3.2+. As of April 26th, 2024, the original neofetch is no longer maintained, but some of its forks are still updated.
...
-   [[1] [Installation]](#Installation)
    ...
    -   [[1.3] [Alternative implementations]](#Alternative_implementations)
        -   [[1.3.1] [fastfetch]](#fastfetch)
        -   [[1.3.2] [hyfetch]](#hyfetch)
...
### [USE flags for] [app-misc/neofetch](https://packages.gentoo.org/packages/app-misc/neofetch) [[]] [Simple information system script]

[Data provided by the [Gentoo Package Database](https://packages.gentoo.org) · Last update: 2026-02-21 15:28] [[More information about USE flags](/wiki/Handbook:AMD64/Working/USE)]

### [Emerge]

`root `[`#`]`emerge --ask app-misc/neofetch`

### [Alternative implementations]

Alternatively, other fetch implementations exist. Fastfetch, written in C, is designed to be a faster version of neofetch. Hyfetch, written in Python, optionally but primarily colors the distro\'s logo with a pride flag.

#### [fastfetch]

See: [Fastfetch](https://wiki.gentoo.org/wiki/Fastfetch "Fastfetch")

#### [hyfetch]

`root `[`#`]`emerge --ask app-misc/hyfetch`

** Note**\
[[[app-misc/hyfetch]](https://packages.gentoo.org/packages/app-misc/hyfetch)[]] has an updated, original version of neofetch, which is launched with \'neowofetch\'.

## [Configuration]

### [Files]

-   [\$/.config/neofetch/config.conf] - User configuration file for neofetch and neowofetch. For more information on customizing check out the [Neofetch\'s wiki](https://github.com/dylanaraps/neofetch/wiki/Customizing-Info).

## [Usage]

neofetch can be used to determine basic system information by issuing the command without any options:

`user `[`$`]`neofetch`

             -/oyddmdhs+:.                larry@gentoo
         -odNMMMMMMMMNNmhy+-`             ------------
       -yNMMMMMMMMMMMNNNmmdhy+-           OS: Gentoo Base System release 2.8 x86_64
     `omMMMMMMMMMMMMNmdmmmmddhhy/`        Kernel: 5.14.7-gentoo-x86_64
     omMMMMMMMMMMMNhhyyyohmdddhhhdo`      Uptime: 75 days, 7 hours, 19 mins
    .ydMMMMMMMMMMdhs++so/smdddhhhhdm+`    Packages: 1279 (emerge)
     oyhdmNMMMMMMMNdyooydmddddhhhhyhNd.   Shell: bash 5.1.12
      :oyhhdNNMMMMMMMNNNmmdddhhhhhyymMh   Terminal: /dev/pts/0
        .:+sydNMMMMMNNNmmmdddhhhhhhmMmy   CPU: AMD Phenom II X4 955 (4) @ 3.200GHz
           /mMMMMMMNNNmmmdddhhhhhmMNhs:   GPU: NVIDIA GeForce4 MX 4000
        `oNMMMMMMMNNNmmmddddhhdmMNhs+`    Memory: 463MiB / 5872MiB
...
When running hyfetch, a configuration utility will be launched. A 74 \* 30 terminal is the recommended minimum requirement.
...
`user `[`$`]`neofetch --help`
    ...
    ASCII:
        ...
        --ascii_distro distro       Which Distro's ascii art to print
                                    ...
                                    NOTE: Use '_old' to use the old logos.
                                    ...
                                    NOTE: Use '_small' to use the small variants.
...
-   [awesome-fetch\'s list of fetching applications](https://github.com/beucismis/awesome-fetch)
