...
[[]][Specifications](https://psref.lenovo.com/syspool/Sys/PDF/withdrawnbook/ltwbook_2013.pdf#%5B%7B%22num%22%3A1505%2C%22gen%22%3A0%7D%2C%7B%22name%22%3A%22FitH%22%7D%2C794%5D)

[[]][Hardware Maintenance Manual](https://download.lenovo.com/ibmdl/pub/pc/pccbbs/mobiles_pdf/42x3550_03.pdf)

[[]][ThinkPad X series](https://en.wikipedia.org/wiki/ThinkPad_X_series#X61_and_X61s "wikipedia:ThinkPad X series")

## Contents

-   [[1] [Hardware configuration]](#Hardware_configuration)
-   [[2] [Patching Linux kernel to get Atheros WIFI \[168c:001c\] LED works]](#Patching_Linux_kernel_to_get_Atheros_WIFI_.5B168c:001c.5D_LED_works)
-   [[3] [Kernel config]](#Kernel_config)
-   [[4] [Updating BIOS to get SATA2 interface with increased speed]](#Updating_BIOS_to_get_SATA2_interface_with_increased_speed)
...
Example of kernel configuration: [X61-kernel-config](https://raw.githubusercontent.com/serge123/atheros-ar242x-ar542x-wifi-laptop-led-support/master/x61-kernel-config)
...
[Modified BIOS with SATA2 3 Gb/s](http://www.thinkwiki.org/wiki/Middleton%27s_BIOS)