...
The output from [lspci -nn] command:
...
`root `[`#`]`echo 800 > /sys/class/backlight/gmux_backlight/brightness`

Alternatively, install [[[sys-power/acpilight]](https://packages.gentoo.org/packages/sys-power/acpilight)[]] which automates this via the [xbacklight] command.