...
[[]][Package information](https://packages.gentoo.org/packages/media-video/ffmpeg)

[[]][Wikipedia](https://en.wikipedia.org/wiki/FFmpeg "wikipedia:FFmpeg")

[[]][GitWeb](https://git.videolan.org/?p=ffmpeg.git;a=tree)

[[]][GitHub](https://github.com/FFmpeg/FFmpeg)

[[]][Official project wiki](https://trac.ffmpeg.org/)

[[]][Bugs (upstream)](https://ffmpeg.org/bugreports.html)

[[]][[#ffmpeg](ircs://irc.libera.chat/#ffmpeg)] ([[webchat](https://web.libera.chat/#ffmpeg)])

[![Ohloh Logo](/images/thumb/c/c1/Ohloh-logo.png/30px-Ohloh-logo.png)][Open Hub](https://www.openhub.net/p/ffmpeg)

**FFmpeg** is a cross platform, free, open source media encoder/decoder toolkit. It contains the programs and libraries necessary to convert audio and video into a wide range of formats. FFmpeg was written by Fabrice Bellard (creator of [QEMU](https://wiki.gentoo.org/wiki/QEMU "QEMU") and the BPG image format).
...
-   [[1] [Installation]](#Installation)
    ...
    -   [[1.2] [Emerge]](#Emerge)
-   [[2] [Usage]](#Usage)
    -   [[2.1] [Media player (ffplay)]](#Media_player_.28ffplay.29)
    -   [[2.2] [Watch YouTube videos]](#Watch_YouTube_videos)
    -   [[2.3] [Play a sequence of images as a video]](#Play_a_sequence_of_images_as_a_video)
    -   [[2.4] [Display webcam output]](#Display_webcam_output)
-   [[3] [Video Encoding]](#Video_Encoding)
    -   [[3.1] [Convert video to AVI with specific codecs]](#Convert_video_to_AVI_with_specific_codecs)
    -   [[3.2] [Extract frames from video]](#Extract_frames_from_video)
    -   [[3.3] [Create video from frames]](#Create_video_from_frames)
    -   [[3.4] [Convert video to 3GP format]](#Convert_video_to_3GP_format)
    -   [[3.5] [Capture screen video using FFmpeg]](#Capture_screen_video_using_FFmpeg)
    -   [[3.6] [Convert video to WebM format]](#Convert_video_to_WebM_format)
    -   [[3.7] [Create MPEG video from a sequence of images]](#Create_MPEG_video_from_a_sequence_of_images)
    -   [[3.8] [Create video with images and audio]](#Create_video_with_images_and_audio)
    -   [[3.9] [Convert AVI video to WebM format with experimental codec]](#Convert_AVI_video_to_WebM_format_with_experimental_codec)
    -   [[3.10] [Convert video to MP4 format for iPod]](#Convert_video_to_MP4_format_for_iPod)
    -   [[3.11] [Convert video to MPEG format for VCD]](#Convert_video_to_MPEG_format_for_VCD)
-   [[4] [Audio encoding]](#Audio_encoding)
    -   [[4.1] [Convert audio to MP3]](#Convert_audio_to_MP3)
    -   [[4.2] [Convert audio to FLAC]](#Convert_audio_to_FLAC)
    -   [[4.3] [Extract audio from FLV video]](#Extract_audio_from_FLV_video)
    -   [[4.4] [Trim audio file]](#Trim_audio_file)
    -   [[4.5] [Extract audio from video file and keep the same format]](#Extract_audio_from_video_file_and_keep_the_same_format)
    -   [[4.6] [Extract audio from video and convert to MP3]](#Extract_audio_from_video_and_convert_to_MP3)
    -   [[4.7] [Extract audio and video streams and combine them]](#Extract_audio_and_video_streams_and_combine_them)
    -   [[4.8] [Combine video and audio files into a single file]](#Combine_video_and_audio_files_into_a_single_file)
-   [[5] [Image encoding]](#Image_encoding)
    -   [[5.1] [Convert audio with image to video]](#Convert_audio_with_image_to_video)
    -   [[5.2] [Create a slideshow with background music]](#Create_a_slideshow_with_background_music)
    -   [[5.3] [Resize an image]](#Resize_an_image)
    -   [[5.4] [Crop an image]](#Crop_an_image)
    -   [[5.5] [Add a border to an image]](#Add_a_border_to_an_image)
    -   [[5.6] [Convert an image to grayscale]](#Convert_an_image_to_grayscale)
    -   [[5.7] [Apply a sepia filter to an image]](#Apply_a_sepia_filter_to_an_image)
    -   [[5.8] [Rotate an image]](#Rotate_an_image)
    -   [[5.9] [Extract a single frame from a video]](#Extract_a_single_frame_from_a_video)
    -   [[5.10] [Apply a blur effect to an image]](#Apply_a_blur_effect_to_an_image)
    -   [[5.11] [Adjust the brightness of an image]](#Adjust_the_brightness_of_an_image)
    -   [[5.12] [Apply a color filter to an image]](#Apply_a_color_filter_to_an_image)
    -   [[5.13] [Apply a fisheye effect to an image]](#Apply_a_fisheye_effect_to_an_image)
    -   [[5.14] [Convert an image to a specific color space]](#Convert_an_image_to_a_specific_color_space)
    -   [[5.15] [Apply a vignette effect to an image]](#Apply_a_vignette_effect_to_an_image)
    -   [[5.16] [Apply a sketch effect to an image]](#Apply_a_sketch_effect_to_an_image)
    -   [[5.17] [Apply a mosaic effect to an image]](#Apply_a_mosaic_effect_to_an_image)
-   [[6] [See also]](#See_also)
...
Some packages know the [`ffmpeg`](https://packages.gentoo.org/useflags/ffmpeg) [USE flag](https://wiki.gentoo.org/wiki/USE_flag "USE flag") for enabling [ffmpeg](https://packages.gentoo.org/packages/media-video/ffmpeg)-based audio/video codec support.
...
The above list is non-comprehensive. Use [equery] (part of [[[app-portage/gentoolkit]](https://packages.gentoo.org/packages/app-portage/gentoolkit)[]]) to see all available flags:
...
`user `[`$`]`ffplay -h`
    ...
    AVCodecContext AVOptions:
      ...
      -sub_charenc_mode  <flags>      .D...S..... set input text subtitles character encoding mode (default 0)
         ...
         pre_decoder                  .D...S.....
         ignore                       .D...S.....
      -sub_text_format   <int>        .D...S....P Deprecated, does nothing (from 0 to 1) (default ass)
         ass             0            .D...S.....
    ...
    http AVOptions:
      ...
      -user_agent        <string>     .D......... override User-Agent header (default "Lavf/59.27.100")
    ...
    libsmbc AVOptions:
      -timeout           <int>        ED......... set timeout in ms of socket I/O operations (from -1 to INT_MAX) (default -1)
      -workgroup         <string>     ED......... set the workgroup used for making connections
    ...
    RTSP muxer AVOptions:
      ...
      -user_agent        <string>     .D......... override User-Agent header (default "Lavf59.27.100")
    ...
    kmsgrab indev AVOptions:
      ...
      -format                .D......... Pixel format for framebuffer (default none)
    ...
    Pulse indev AVOptions:
      ...
      -name              <string>     .D......... set application name (default "Lavf59.27.100")
    ...
    astats AVOptions:
       ...
       measure_overall   <flags>      ..F.A...... Select the parameters which are measured overall (default all+DC_offset+Min_level+Max_level+Min_difference+Max_difference+Mean_difference+RMS_difference+Peak_level+RMS_level+RMS_peak+RMS_trough+Crest_factor+Flat_factor+Peak_count+Bit_depth+Dynamic_range+Zero_crossings+Zero_crossings_rate+Noise_floor+Noise_floor_count+Entropy+Number_of_samples+Number_of_NaNs+Number_of_Infs+Number_of_denormals)
         none                         ..F.A......
         all                          ..F.A......
         DC_offset                    ..F.A......
         Min_level                    ..F.A......
    ...
    axcorrelate AVOptions:
       ...
       algo              <int>        ..F.A...... set algorithm (from 0 to 1) (default slow)
    ...
    surround AVOptions:
       ...
       fcx               <float>      ..F.A...... set front center channel x spread (from 0.06 to 15) (default 0.5)
       flx               <float>      ..F.A...... set front left channel x spread (from 0.06 to 15) (default 0.5)
       frx               <float>      ..F.A...... set front right channel x spread (from 0.06 to 15) (default 0.5)
       blx               <float>      ..F.A...... set back left channel x spread (from 0.06 to 15) (default 0.5)
       brx               <float>      ..F.A...... set back right channel x spread (from 0.06 to 15) (default 0.5)
       slx               <float>      ..F.A...... set side left channel x spread (from 0.06 to 15) (default 0.5)
       srx               <float>      ..F.A...... set side right channel x spread (from 0.06 to 15) (default 0.5)
       bcx               <float>      ..F.A...... set back center channel x spread (from 0.06 to 15) (default 0.5)
       fcy               <float>      ..F.A...... set front center channel y spread (from 0.06 to 15) (default 0.5)
       fly               <float>      ..F.A...... set front left channel y spread (from 0.06 to 15) (default 0.5)
       fry               <float>      ..F.A...... set front right channel y spread (from 0.06 to 15) (default 0.5)
       bly               <float>      ..F.A...... set back left channel y spread (from 0.06 to 15) (default 0.5)
       bry               <float>      ..F.A...... set back right channel y spread (from 0.06 to 15) (default 0.5)
       sly               <float>      ..F.A...... set side left channel y spread (from 0.06 to 15) (default 0.5)
       sry               <float>      ..F.A...... set side right channel y spread (from 0.06 to 15) (default 0.5)
       bcy               <float>      ..F.A...... set back center channel y spread (from 0.06 to 15) (default 0.5)
    ...
    estdif AVOptions:
       ...
       ecost             <float>      ..FV.....T. specify the edge cost for edge matching (from 0 to 9) (default 1)
       mcost             <float>      ..FV.....T. specify the middle cost for edge matching (from 0 to 1) (default 0.5)
       dcost             <float>      ..FV.....T. specify the distance cost for edge matching (from 0 to 1) (default 0.5)
    ...
    fftdnoiz AVOptions:
       ...
       window            <int>        ..FV....... set window function (from 0 to 19) (default hann)
    ...
    iccdetect AVOptions:
       force             <boolean>    ..FV....... overwrite existing tags (default true)

    iccgen AVOptions:
       color_primaries   <int>        ..FV....... select color primaries (from 0 to 22) (default auto)
         ...
         jedec-p22       22           ..FV.......
         ebu3213         22           ..FV.......
       color_trc         <int>        ..FV....... select color transfer (from 0 to 18) (default auto)
         auto            0            ..FV....... infer based on frame
         bt709           1            ..FV.......
         bt470m          4            ..FV.......
         bt470bg         5            ..FV.......
         ...
         smpte2084       16           ..FV.......
         arib-std-b67    18           ..FV.......
       force             <boolean>    ..FV....... overwrite existing ICC profile (default false)
    ...
    palettegen AVOptions:
       ...
       use_alpha         <boolean>    ..FV....... create a palette including alpha values (default false)
    ...
    pseudocolor AVOptions:
       ...
       preset            <int>        ..FV.....T. set preset (from -1 to 13) (default none)
         none            -1           ..FV.....T.
         magma           0            ..FV.....T.
         inferno         1            ..FV.....T.
         plasma          2            ..FV.....T.
         ...
         preferred       12           ..FV.....T.
         total           13           ..FV.....T.
       p                 <int>        ..FV.....T. set preset (from -1 to 13) (default none)
         none            -1           ..FV.....T.
         magma           0            ..FV.....T.
         inferno         1            ..FV.....T.
         plasma          2            ..FV.....T.
    ...
    avectorscope AVOptions:
       ...
       draw              <int>        ..FV.....T. set draw mode (from 0 to 1) (default dot)
         dot             0            ..FV.....T.
         line            1            ..FV.....T.
    ...
    avsynctest AVOptions:
       ...
       amplitude         <float>      ..F.A...... set beep amplitude (from 0 to 1) (default 0.7)
       a                 <float>      ..F.A...... set beep amplitude (from 0 to 1) (default 0.7)
       period            <int>        ..F.A...... set beep period (from 1 to 99) (default 3)
       p                 <int>        ..F.A...... set beep period (from 1 to 99) (default 3)
       delay             <int>        ..FV....... set flash delay (from -30 to 30) (default 0)
       dl                <int>        ..FV....... set flash delay (from -30 to 30) (default 0)
       cycle             <boolean>    ..FV....... set delay cycle (default false)
       c                 <boolean>    ..FV....... set delay cycle (default false)
...
`user `[`$`]`ffmpeg -f x11grab -s $(xdpyinfo | grep 'dimensions:'|awk '') -r 25 -i :0.0 -sameq /tmp/out.mpg > ~/howto/capture_screen_video_ffmpeg`
...
-   [Extract Blu-ray audio with FFmpeg](https://wiki.gentoo.org/wiki/Extract_Blu-ray_audio_with_FFmpeg "Extract Blu-ray audio with FFmpeg") --- extracting Blu-Ray audio with [FFmpeg]

## [External resources]

-   [\[HOWTO\] using ffplay as your default player for audio/video](https://forum.odroid.com/viewtopic.php?f=52&t=2028)