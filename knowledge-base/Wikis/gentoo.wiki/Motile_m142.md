[] This article is a [stub](https://wiki.gentoo.org/wiki/Category:Stub "Category:Stub"). Please help out by [expanding it](https://wiki.gentoo.org/index.php?title=Motile_m142&action=edit) - [how to get started](https://wiki.gentoo.org/wiki/Gentoo_Wiki:Contributor%27s_guide "Gentoo Wiki:Contributor's guide").
...
-   [[1] [Hardware]](#Hardware)
    ...
    -   [[1.9] [USB]](#USB)
    -   [[1.10] [SATA, PCI]](#SATA.2C_PCI)
    -   [[1.11] [NVME SSD]](#NVME_SSD)
    -   [[1.12] [Webcam]](#Webcam)
