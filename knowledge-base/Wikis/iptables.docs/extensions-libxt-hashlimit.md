...
Match if the rate is below or equal to *amount*/quantum. It is specified either as a number, with an optional time quantum suffix (the default is 3/hour), or as *amount*b/second (number of bytes per second).
