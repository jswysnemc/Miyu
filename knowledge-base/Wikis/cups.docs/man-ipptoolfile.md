...
Requires that all values of the **EXPECT** attribute match ("="), do not match ("!"), are less than ("\<"), or are greater than ("\>") the number(s). When comparing rangeOfInteger values, the "\<" and "\>" operators only check the upper bound of the range, "=" checks for inclusion in a range, and "!" checks for exclusion of a range.
...
Requires that at least one value of the **EXPECT** attribute matches ("="), does not match ("!"), is less than ("\<"), or is greater than ("\>") the number(s). When comparing rangeOfInteger values, the "\<" and "\>" operators only check the upper bound of the range, "=" checks for inclusion in a range, and "!" checks for exclusion of a range.
...
**RESOLUTION max**
**RESOLUTION min**
**RESOLUTION** *resolution***dpcm**
**RESOLUTION** *horzontal***x***vertical***dpcm**
**RESOLUTION** *resolution***dpi**
**RESOLUTION** *horizontal***x***vertical***dpi**
