...
The System V versions of these commands are **disable** and **enable**, respectively. They have been renamed to avoid conflicts with the **bash**(1) built-in commands of the same names.
