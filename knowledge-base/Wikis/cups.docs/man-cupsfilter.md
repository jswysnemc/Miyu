...
**cupsfilter** \[ **--list-all** \] \[ **--list-filters** \] \[ **-D** \] \[ **-U** *user* \] \[ **-c** *config-file* \] \[ **-d** *printer* \] \[ **-e** \] \[ **-i** *mime/type* \] \[ **-j** *job-id\[,N\]* \] \[ **-m** *mime/type* \] \[ **-n** *copies* \] \[ **-o** *name=value* \] \[ **-p** *filename.ppd* \] \[ **-t** *title* \] \[ **-u** \] *filename*
