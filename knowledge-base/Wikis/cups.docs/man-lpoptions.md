...
**lpoptions** \[ **-h** *server*\[**:***port*\] \] \[ **-E** \] \[ **-p** *destination*\[**/***instance*\] \] **-o** *option*\[**=***value*\] ...
**lpoptions** \[ **-h** *server*\[**:***port*\] \] \[ **-E** \] \[ **-p** *destination*\[**/***instance*\] \] **-r** *option*
...
When run by the root user, **lpoptions** gets and sets default options and instances for all users in the */etc/cups/lpoptions* file. Otherwise, the per-user defaults are managed in the *$HOME/.cups/lpoptions* file.
...
*$HOME/.cups/lpoptions* - user defaults and instances created by non-root users.
