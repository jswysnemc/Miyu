...
![Bottle - Backup Menu](/files/QqA0esPHFUc6ZFh126EQ)

### How to backup

To backup your bottle, just go to the bottle details view and press the button ![Bottle - Backup Button](/files/qhcO6SL8qlwrDayDrJxx) at the top right of your bottle, then select the backup method you prefer.
...
You can also import the backup of a bottle, using our [Importer](/bottles/import-from-other-managers.md).
