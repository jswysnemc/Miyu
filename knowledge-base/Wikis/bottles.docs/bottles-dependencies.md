...
![Bottle - Dependencies](/files/NXIl326mrM80kygT77Gh)
...
You can switch to multiselection mode using the button ![Bottle - Dependencies - Selection Button](/files/m9SFMUV6mpWHEx0vr5jA).

![Bottle - Dependencies - Multiple Selection](/files/DpJKgNgcZmK8aY4VG4a4)
