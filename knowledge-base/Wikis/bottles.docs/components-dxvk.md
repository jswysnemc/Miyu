...
![Bottle - Preferences - DXVK toggle](/files/3LJGDCEvp6PiSbRyu9n3)

## DXVK updates

You can keep this component updated from main Bottles preferences ("DLL Components" tab).

![Preferences - DXVK](/files/Kb7KxcA2BfSrDVFIzgWg)
...
![Bottle - Preferences - DXVK versioin](/files/4AA3OHmF1rhuKg1liSY1)
...
![Bottle - Preferences - Environment variables](/files/hgz0dg4dDzDWoryfSD5c)
