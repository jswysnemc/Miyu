...
* a powerful, integrated and written from scratch [dependency manager](/bottles/dependencies.md) based on a [community driven](/contribute/missing-dependencies.md) and easy to expand repository
...
* [full-sandbox](/flatpak/cant-enable-steam-proton-manager.md) (via Flatpak)
