...
-->
    ...
    window:
     ...
     xprop -root | grep ^PULSE_
        ...
        Read the PulseAudio server credentials currently set
      ...
      properties.
        ...
        -i
        Similar to  -d , however dumps them in a
      ...
      authentication cookie from the root window and stores it in
       $HOME/.config/pulse/cookie .
        ...
        Export the currently locally used sound server,
      ...
      environment variables and combines them with the data from
       $HOME/.config/pulse/client.conf  (or
      ...
      authentication cookie  $HOME/.config/pulse/cookie  to the X11
      server.
        ...
        Only valid for  -e : export the specified
      PulseAudio server as default to the X11 display instead of the
      one configured via local configuration.
      ...
      display instead of the one stored in  $HOME/.config/pulse/cookie .
