...
1.  [Automatic rollbacks](#automatic-rollbacks)
2.  [Manual rollbacks](#manual-rollbacks)
3.  [Rollbacks](#rollbacks)
4.  [Alternate rollback techniques](#alternate-rollback-techniques)

## Automatic rollbacks

See [greenboot](https://github.com/fedora-iot/greenboot/blob/main/README.md) for information on automatic rollbacks and how to integrate without your bootloader.
