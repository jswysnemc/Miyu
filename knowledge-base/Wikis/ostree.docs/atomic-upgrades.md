...
1.  [You can turn off the power anytime you want…](#you-can-turn-off-the-power-anytime-you-want)
2.  [Simple upgrades via HTTP](#simple-upgrades-via-http)
3.  [Upgrades via external tools (e.g. package managers)](#upgrades-via-external-tools-eg-package-managers)
4.  [Assembling a new deployment directory](#assembling-a-new-deployment-directory)
5.  [Atomically swapping boot configuration](#atomically-swapping-boot-configuration)
6.  [The bootversion](#the-bootversion)
7.  [The /ostree/boot directory](#the-ostreeboot-directory)
8.  [The /boot/ostree directory](#the-bootostree-directory)
