...
3.  [Comparison with “package managers”](#comparison-with-package-managers)
4.  [Comparison with block/image replication](#comparison-with-blockimage-replication)
5.  [Atomic transitions between parallel-installable read-only filesystem trees](#atomic-transitions-between-parallel-installable-read-only-filesystem-trees)
...
OSTree is orthogonal to virtualization mechanisms like AMIs and qcow2 images. It targets updating stateful VMs in-place, rather than generating new images.
