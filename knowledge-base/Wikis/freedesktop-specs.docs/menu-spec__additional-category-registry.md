...
| LauncherStore | A place to browse and install games or a launcher for a game or games | Game |
| GameTool | Companion apps for games, such as addon managers, remote play clients or other tools | Game |
| Exercise | Tracking exercise, showing exercise videos, or syncing with gym equipment | HealthFitness |
| Medication | Understanding or tracking medication | HealthFitness |
| Mindfulness | Meditation, journaling, digital-wellbeing, therapy, or other mental health | HealthFitness |
| Nutrition | Nutrition or hydration tracking, weight control, body composition, or meal planning | HealthFitness |
| CareProvider | Communicating with your doctor, scheduling an appointment, viewing test results, or managing your medical insurance | HealthFitness |
| Sleep | Sleep monitoring or tracking, or assistance with sleepnesses | HealthFitness |
