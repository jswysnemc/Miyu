...
**原因：** Last updated in 2012（在 [Talk:Smart Common Input Method#](<../zh-cn/Talk:Smart_Common_Input_Method.html>) 中讨论）

**警告：** SCIM 已经 "不被开发者维护", 而 IBus 被 Red Hat 积极开发。Arch 用户安装软件时应该考虑用 [fcitx](<../zh-cn/Fcitx.html> "Fcitx")、[IBus](<../zh-cn/IBus.html> "IBus") 或 [Uim](</wzh/index.php?title=Uim&action=edit&redlink=1> "Uim（页面不存在）") 而不是 [SCIM](</wzh/index.php?title=SCIM&action=edit&redlink=1> "SCIM（页面不存在）")。
...
目前SCIM包含许多各类的输入法（有些可能需要一些其它的库），覆盖30多种语言，包括中文（简体、繁体）、日文、韩文及许多欧洲语言： 
    ...
    (在[这里](<https://web.archive.org/web/20130318035826/https://www.scim-im.org/projects/imengines>)
...
查看[这里](<https://archlinux.org/news/166/>)获得更多官方信息。 
...
如果 _export QT_IM_MODULE="scim"_ 无法工作，可以使用 AUR 中的 [scim-bridge](<https://aur.archlinux.org/packages/scim-bridge/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]。在 2009.02.15 的更新中(scim 1.4.7-1, AUR 中的 scim-bridge 0.4.15-1)下面配置可以在 GNOME, XFCE, LXDE 中工作： 
    
    export QT_IM_MODULE="scim-bridge"
    
#### KDE3

将 QT IMM 设为 **xim** 或安装 AUR 中的 [scim-qtimm-cvs](<https://aur.archlinux.org/packages/scim-qtimm-cvs/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]: 
...
或者采取： 
  ...
  1. 从 [AUR](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "AUR") 安装 **skim**.
...
参见 [[1]](<https://archive.today/2013.06.20-224009/http://www.scim-im.org/forums%23nabble-td2499750>) 和 [[2]](<https://ubuntuforums.org/showthread.php?t=1641861>). 

##  外部链接

  * [See the official news page for more details](<https://archlinux.org/news/166/>).
