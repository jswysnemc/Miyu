...
**原因：** 请提供模板的第一个位置参数以概括原因。 (在[Talk:MentoHUST](<../zh-cn/Talk:MentoHUST.html>)讨论)

[![](../File:Gnome-colors-add-files-to-archive.png)](<../File:Gnome-colors-add-files-to-archive.png>)**本页面正在考虑[归档](<../Project:%E5%BD%92%E6%A1%A3.html> "Project:Archive")。**

**原因：** The package in the AUR, as well as the upstream package, has stopped maintenance.（在 [Talk:MentoHUST](<../zh-cn/Talk:MentoHUST.html>) 中讨论）
...
安装 [AUR](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "Arch 用户软件仓库") 中的 [mentohust-git](<https://aur.archlinux.org/packages/mentohust-git/>)AUR 即可。 

**注意：**[mentohust-git](<https://aur.archlinux.org/packages/mentohust-git/>)AUR 目前还在开发中，主要针对锐捷v4算法，暂不兼容旧版本的mentohust，若使用出现问题，可尝试旧版本的[mentohust](<https://code.google.com/archive/p/mentohust/downloads>),亦可安装[AUR](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "Arch 用户软件仓库")中的旧版本[mentohust](<https://aur.archlinux.org/packages/mentohust/>)AUR 。 
...
可参见 [MentoHUST 及‘二次拨号’的临时解决方案](<http://arch.acgtyrant.com/2014/02/23/mentohust-and-l2tp/>)
