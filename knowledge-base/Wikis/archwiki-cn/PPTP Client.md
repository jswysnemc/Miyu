...
**原因：** 请提供模板的第一个位置参数以概括原因。 (在[Talk:PPTP Client](<../zh-cn/Talk:PPTP_Client.html>)讨论)
...
**原因：** Last updated in 2011, out of sync with English page（在 [Talk:PPTP Client#](<../zh-cn/Talk:PPTP_Client.html>) 中讨论）
