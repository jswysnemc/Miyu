...
**本文所述教程或工具由于已经过时而被弃用，请使用其他替代方案：** [ATI](<../zh-cn/ATI.html> "ATI")、[AMDGPU](<../zh-cn/AMDGPU.html> "AMDGPU") 和 [AMDGPU PRO](<../zh-cn/AMDGPU_PRO.html> "AMDGPU PRO") (在[Talk:AMD Catalyst](<../zh-cn/Talk:AMD_Catalyst.html>)讨论)
...
AMD 的显卡驱动有两种：一是官方私有驱动 ([catalyst](<https://aur.archlinux.org/packages/catalyst/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found])，二是开源驱动（较旧的显卡参见 [ATI](<../zh-cn/ATI.html> "ATI")，较新的显卡参见 [AMDGPU](<../zh-cn/AMDGPU.html> "AMDGPU")）。本文主要介绍私有驱动。 

**警告：** 官方仓库不再提供 Catalyst。 AMD 已经不再更新这个软件包，而且此软件包与最新的 Xorg 不兼容，需要先安装老的 Xorg 才能使用。

AMD 的 Linux 驱动软件包 _catalyst_ 驱动曾被命名为 _fglrx_ (**F** ire**GL** and **R** adeon **X**)。现在虽然改变了软件包名称，但内核模块文件名依然为以前的 _fglrx.ko_ 。因此，下文中任何提及 fglrx 都是指 _内核模块_ ,而**不是指软件包**. 

与开源驱动相比，Catalyst 在 2D 上表现比较差，在 3D 上与开源驱动差不多，但缺乏高效的多显支持。Catalyst 支持芯片组 R600 及以上（Radeon HD 2xxx 或者更新）的 [ATI/AMD Radeon](<https://en.wikipedia.org/wiki/Radeon> "wikipedia:Radeon") 显卡。 _model_ 名称（如 X1900，HD4850）与 _chip_ 名称（分别是R580，RV770）间的对照请参见 Xorg [decoder ring](<https://www.x.org/wiki/RadeonFeature/#index5h2>) 或者[这个表格](<https://en.wikipedia.org/wiki/Comparison_of_AMD_graphics_processing_units> "wikipedia:Comparison of AMD graphics processing units")。 
...
如果你不喜欢通过 [AUR](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "AUR") 来安装，则使用此方法。此软件库由我们的非官方 Catalyst 维护者 [Vi0l0](</wzh/index.php?title=User:Vi0L0&action=edit&redlink=1> "User:Vi0L0（页面不存在）") 维护。所有的包都经过签名，所以安全方面无需担心。下文提及的很多其他与 AMD 显卡有关的包也是由 Vi0L0 维护。 

Vi0L0 有三个不同的 Catalyst 软件库: 

  * [catalyst](<../zh-cn/Unofficial_user_repositories.html#catalyst> "Unofficial user repositories")[[损坏的链接](<../Project:%E7%A4%BE%E7%BE%A4%E9%A6%96%E9%A1%B5.html#%E6%8D%9F%E5%9D%8F%E7%9A%84%E9%93%BE%E6%8E%A5> "Project:社群首页")：无效的章节]：Radeon HD 5xxx 及更新的显卡使用的普通 Catalyst 驱动。包含了最新的 (稳定版或者 beta 版) Catalyst。
  * _catalyst-stable_ ：Radeon HD 5xxx 及更新的显卡使用的普通 Catalyst 驱动。包含了最新的稳定版 Catalyst。
  * [catalyst-hd234k](<../zh-cn/Unofficial_user_repositories.html#catalyst-hd234k> "Unofficial user repositories")[[损坏的链接](<../Project:%E7%A4%BE%E7%BE%A4%E9%A6%96%E9%A1%B5.html#%E6%8D%9F%E5%9D%8F%E7%9A%84%E9%93%BE%E6%8E%A5> "Project:社群首页")：无效的章节]：Radeon HD 2xxx，3xxx 与 4xxx 显卡使用的 legacy Catalyst 驱动。

要启用上述软件库的话，参见 [Unofficial user repositories](<../zh-cn/Unofficial_user_repositories.html> "Unofficial user repositories") 中所述方法。记得在 `pacman.conf` 中的**其他软件库之前** 添加相应软件库。 

**注意：** _catalyst_ 和 _catalyst-stable_ 软件库的 URL 相同。若要启用 _catalyst-stable_ ，步骤与启用 _catalyst_ 相同，并在 `pacman.conf` 中将 `[catalyst]` 替换成 `[catalyst-stable]`。如果你需要某个旧版本，这儿也有并且 URL 也相同（比如 _catalyst-stable-13.4_ ）。

**提示：** 有时 catalyst.wirephire.com 因为超出带宽上限而不能提供下载（曾发生过这个问题），或者你到这个服务器的连接很慢，这时，你可以尝试另外的镜像服务器：[[1]](<http://mirror.hactar.bz/Vi0L0/>)[[失效链接](<https://zh.wikipedia.org/wiki/Wikipedia:%E5%A4%B1%E6%95%88%E9%93%BE%E6%8E%A5> "zhwp:Wikipedia:失效链接") 2020-08-02 ⓘ]（goll 提供，德国）。不过。这些服务器也不保证随时可用。 

完成后更新 pacman 数据库并[安装](<../zh-cn/Help:%E9%98%85%E8%AF%BB.html#%E5%AE%89%E8%A3%85%E8%BD%AF%E4%BB%B6%E5%8C%85> "安装")这些软件包（更多信息参见[#工具](<#%E5%B7%A5%E5%85%B7>)）： 
...
还可以通过 [AUR](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "AUR") 安装。如果你需为你的电脑进行定制安装，则用此方法。此方法极为繁琐，因为它需要的工作量最大，而且每次内核更新后你得手动更新 Catalyst。 

**警告：** 若通过 AUR 安装 Catalyst，每次内核更新你都得重新编译 Catalyst，否则 X **将不能** 启动。

在 Vi0L0 的软件库中提到的一切软件包在 [AUR](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "AUR") 中也可用： 

  * [Catalyst](<https://aur.archlinux.org/packages/Catalyst/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]
  * [Catalyst-generator](<https://aur.archlinux.org/packages/Catalyst-generator/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]
  * [Catalyst-hook](<https://aur.archlinux.org/packages/Catalyst-hook/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]
  * [Catalyst-utils](<https://aur.archlinux.org/packages/Catalyst-utils/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]
  * [Lib32-catalyst-utils](<https://aur.archlinux.org/packages/Lib32-catalyst-utils/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]

AUR还提供些独家软件包。它含有被称为 _Catalyst-total_ 的包和一些 beta 阶段的软件： 

  * [Catalyst-total](<https://aur.archlinux.org/packages/Catalyst-total/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]
  * [Catalyst-total-hd234k](<https://aur.archlinux.org/packages/Catalyst-total-hd234k/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]
  * [Catalyst-test](<https://aur.archlinux.org/packages/Catalyst-test/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]

[catalyst-total](<https://aur.archlinux.org/packages/catalyst-total/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 包能让 AUR 用户更为方便。它能构建驱动、内核工具、32位内核工具和 [catalyst-hook](<https://aur.archlinux.org/packages/catalyst-hook/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]（参见 [#工具](<#%E5%B7%A5%E5%85%B7>)）。 

###  配置驱动

安装完毕后，要配置 X，让其使用 Catalyst。要确保 fglrx 模块在启动阶段加载，而且要禁用[内核级显示模式设置](<../zh-cn/Kernel_mode_setting.html> "Kernel mode setting")。 
...
禁用 `radeon` 以防其自动加载。在 `/etc/modprobe.d/modprobe.conf` 里禁用 _radeon_ ，同时保证它不被 `/etc/modules-load.d/` 里的文件加载。详见 [Kernel modules#黑名单](<../zh-cn/Kernel_modules.html#%E9%BB%91%E5%90%8D%E5%8D%95> "Kernel modules")。 
...
禁用内核级显示模式设置很重要，Catalyst 根本不使用[内核级显示模式](<../zh-cn/Kernel_mode_setting.html> "Kernel mode setting")。否则，当系统切换至TTY或在桌面环境下关机时，系统可能会冻结。 

添加 `nomodeset` 到你的[内核参数](<../zh-cn/Kernel_parameters.html> "Kernel parameters")。 
...
若有输出, 则证明安装成功。可以尝试用 `$ startx` 或者显示管理器来启动 X（参见 [Xorg#Running](<../zh-cn/Xorg.html#Running> "Xorg")）。 
...
若显示 `"direct rendering: yes"`，恭喜你，到位了! 若无 `$ glxinfo` 命令，安装 [mesa-utils](<https://archlinux.org/packages/?name=mesa-utils>)包 package。 
...
**注意：** 如果你讨厌打包或毫无经验，可先阅读 [Arch Build System](<../zh-cn/Arch_Build_System.html> "Arch Build System")。

  1. 从 [Catalyst](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "AUR") 上获取 `PKGBUILD` 和 `catalyst.install` 文件。
...
**注意：**
  ...
  * 如果在安装有多内核的系统上，你必须为所有内核安装 [catalyst-utils](<https://aur.archlinux.org/packages/catalyst-utils/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 包。这不会引起冲突。

  * [catalyst-generator](<https://aur.archlinux.org/packages/catalyst-generator/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 能为你自动构建 `catalyst-{kernver}`，因此这些步骤根本就可省略。请参考 [#工具](<#%E5%B7%A5%E5%85%B7>)部分。
...
如果要在Arch上使用此功能，你将需要： 
  ...
  * 从 [AUR](<../zh-cn/Arch_%E7%94%A8%E6%88%B7%E8%BD%AF%E4%BB%B6%E4%BB%93%E5%BA%93.html> "AUR") 获取并编译 [catalyst-total](<https://aur.archlinux.org/packages/catalyst-total/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] / [catalyst-test](<https://aur.archlinux.org/packages/catalyst-test/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 软件包，或者
  * 从 [catalyst] 软件仓库安装 **catalyst-libgl** 和 **catalyst-utils** 软件包。

对于 Intel 集成显卡的切换，你还需要安装 [mesa](<https://archlinux.org/packages/?name=mesa>)包 软件包和 Intel 的驱动：[xf86-video-intel](<https://archlinux.org/packages/?name=xf86-video-intel>)包。 

**注意：** Catalyst 有时不兼容最新的 Intel 驱动程序。如果遇到这种情况，请降级 [xf86-video-intel](<https://archlinux.org/packages/?name=xf86-video-intel>)包 与 xorg-server 软件包到 [Arch Linux Archive](<../zh-cn/Arch_Linux_Archive.html> "Arch Linux Archive") 或者 [#Xorg 软件库](<#Xorg_%E8%BD%AF%E4%BB%B6%E5%BA%93>) 上的先前版本。
...
要启用上述软件库的话,参见 [Unofficial user repositories](<../zh-cn/Unofficial_user_repositories.html> "Unofficial user repositories") 中所述方法. 记得在 `pacman.conf` 中的**其他软件库之前（甚至在你的 catalyst 仓库前，如果你有的话）** 添加相应软件库（使用和 [catalyst](<../zh-cn/Unofficial_user_repositories.html#catalyst> "Unofficial user repositories")[[损坏的链接](<../Project:%E7%A4%BE%E7%BE%A4%E9%A6%96%E9%A1%B5.html#%E6%8D%9F%E5%9D%8F%E7%9A%84%E9%93%BE%E6%8E%A5> "Project:社群首页")：无效的章节] 库相同的 PGP 密匙）。 
...
[Catalyst-hook](<https://aur.archlinux.org/packages/Catalyst-hook/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 是一个 [systemd](<../zh-cn/Systemd.html> "Systemd") 服务,它在系统关机或重启后重新构建 `fglrx` 模块（如果需要的话，比如内核升级后）。 

使用之前请保证 [base-devel](<https://archlinux.org/groups/x86_64/base-devel/>)包组 组和 [linux-headers](<https://archlinux.org/packages/?name=linux-headers>)包 包（对应你的内核）已经安装。 
...
[catalyst-generator](<https://aur.archlinux.org/packages/catalyst-generator/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 包能构建并安装 `fglrx` 模块，该模块与 pacman 兼容的 `catalyst-${kernver}` 相适应。与 [#Catalyst-hook](<#Catalyst-hook>) 的区别是必须手动使用此命令，而 Catalyst-hook 则不需。 

通过 [makepkg](<../zh-cn/Makepkg.html> "Makepkg")，它能构建 `catalyst-${kernver}` 二进制包并用 [pacman](<../zh-cn/Pacman.html> "Pacman") 安装。`${kernver}` 是软件包的目标内核版本（例如 catalyst-2.6.35-ARCH 适用于 2.6.35-ARCH 内核）。 
...
Catalyst-generator 是最安全的,最符合KISS原则的,因为: 
  ...
  1. 你可以使用非特权用户来构建包；
  2. 它在 fakeroot 环境构建包；
  3. 它不乱丢文件，[pacman](<../zh-cn/Pacman.html> "Pacman")知道文件们在哪；
  4. 你需要做的只是，记得去使用它
...
在 AUR 和 [catalyst] 软件仓库，你可以找到这些代表了 AMD 最重要工作的工具软件包： 
  ...
  * [amdapp-aparapi](<https://aur.archlinux.org/packages/amdapp-aparapi/>)AUR
  * [amdapp-sdk](<https://aur.archlinux.org/packages/amdapp-sdk/>)AUR
  * [amdapp-codexl](<https://aur.archlinux.org/packages/amdapp-codexl/>)AUR
...
更多关于 Aparapi 的信息：[参见这里](<http://developer.amd.com/tools/heterogeneous-computing/aparapi/>)[[失效链接](<https://zh.wikipedia.org/wiki/Wikipedia:%E5%A4%B1%E6%95%88%E9%93%BE%E6%8E%A5> "zhwp:Wikipedia:失效链接") 2020-08-02 ⓘ]。 
...
从 2.8 版本开始，amdapp-sdk 提供了 aparapiUtil 和 aparapi 的代码实例。有一个包已经加入到了 [catalyst] 软件仓库。它依赖于 [amdapp-aparapi](<https://aur.archlinux.org/packages/amdapp-aparapi/>)AUR。AUR 中的软件包让你选择需不需要 aparapi's additions。 

2.8 版本没有提供探查功能 (Profiler functionality)，它已经被移到 CodeXL 中了。 

关于 AMD APP SDK 的更多信息：[参见这里](<http://developer.amd.com/tools/heterogeneous-computing/amd-accelerated-parallel-processing-app-sdk/>)[[失效链接](<https://zh.wikipedia.org/wiki/Wikipedia:%E5%A4%B1%E6%95%88%E9%93%BE%E6%8E%A5> "zhwp:Wikipedia:失效链接") 2020-08-02 ⓘ]。 

#### amdapp-codexl

CodeXL 是一个带有静态 OpenCl 内核分析器的 OpenCL and OpenGL 调试器和探查器。它具有 GUI 界面，是在著名的 [gdebugger](<https://aur.archlinux.org/packages/gdebugger/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 基础上完成的。它只支持 x86_64 系统。 

关于 CodeXL 的更多信息：[参见这里](<http://developer.amd.com/tools/heterogeneous-computing/codexl/>)[[失效链接](<https://zh.wikipedia.org/wiki/Wikipedia:%E5%A4%B1%E6%95%88%E9%93%BE%E6%8E%A5> "zhwp:Wikipedia:失效链接") 2020-08-02 ⓘ]。 

##  功能

### Tear Free Rendering

在 **Catalyst 11.1** 中，很可能是添加了三重缓存和 v-sync， _Tear Free Desktop_ 减少了 2D，3D 视频应用的屏幕撕裂毛病。但这需要额外的 GPU 处理。 
...
VA-API 在 [xvba-video](<https://aur.archlinux.org/packages/xvba-video/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 上有一个私有后端（2009年10月），它允许使用 VA-API 的程序通过 [XvBA（AMD 设计的 X-Video 比特流加速 API）](<https://en.wikipedia.org/wiki/XvBA> "wikipedia:XvBA")函数库来充分利用拥有 uvd2（第二代通用视频解码单元）芯片组的视频加速功能。 

**注意：** 使用 `catalyst-test` 或者 `catalyst-total` 时不需要安装 [xvba-video](<https://aur.archlinux.org/packages/xvba-video/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]，因为有已经创建好的符号链接代替。

xvba-video 和支持 XvBA 的软件仍还在开发，**但在大多数情况下它都能很好的工作** 。 通过 AUR 构建（或通过 Vi0L0 的仓库直接安装）专有 [xvba-video](<https://aur.archlinux.org/packages/xvba-video/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 包，若这个版本对你来说有问题，用 [libva-xvba-driver](<https://aur.archlinux.org/packages/libva-xvba-driver/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 取代；并安装 [mplayer-vaapi](<https://aur.archlinux.org/packages/mplayer-vaapi/>)AUR 和 [libva](<https://archlinux.org/packages/?name=libva>)包。然后将视频播放器的视频输出设置为 "vaapi:gl": 
    
    $ mplayer -vo vaapi:gl movie.avi
    
此选项可添加到 mplayer 的配置文件，参考 [MPlayer](<../zh-cn/MPlayer.html> "MPlayer")。 
...
若超频或与之相反，则使用图形工具反而相对容易些，如需要 qt 的 **ATi Overclocking Utility** 。你可以从[这儿](<https://kde-apps.org/content/show.php/ATI+Overclock?content=47796>)找到（不过它可能过时了）。 

更复杂的 [amdoverdrivectrl](<https://aur.archlinux.org/packages/amdoverdrivectrl/>)AUR 也能达到此目的，它的主页是[这里](<https://sourceforge.net/projects/amdovdrvctrl>)。可通过 [amdoverdrivectrl](<https://aur.archlinux.org/packages/amdoverdrivectrl/>)AUR 或 Vi0L0 的非官方软件库构建安装包。 
...
[ATI Documentation](<https://support.amd.com/us/kbarticles/Pages/1105-HowCanIConfigureMultip.aspx>)
...
**警告：****千万不要** 直接使用 sudo。 Sudo 虽能给予管理员权限，却使用用户账户的信息（如环境变量）。GNOME 下使用 _gksu_ ，KDE 下使用 _kdesu_ 。
...
你可能会因为 catalyst 不工作或者是想试试开源驱动而要卸载掉 catalyst：移除 `catalyst` 和 `catalyst-utils` 包。当然你也应该移除 [catalyst-generator](<https://aur.archlinux.org/packages/catalyst-generator/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]，[catalyst-hook](<https://aur.archlinux.org/packages/catalyst-hook/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 和 [lib32-catalyst-utils](<https://aur.archlinux.org/packages/lib32-catalyst-utils/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 包（如果你安装了的话）。 

**警告：**

  * 你也许需要使用 `# pacman -Rdd` 来移除 [catalyst-utils](<https://aur.archlinux.org/packages/catalyst-utils/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]（和/或 [lib32-catalyst-utils](<https://aur.archlinux.org/packages/lib32-catalyst-utils/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found]）因为它（们）包含了 _图形库_ 相关文件，许多包会依赖他们。这些依赖关系将在安装 [xf86-video-ati](<https://archlinux.org/packages/?name=xf86-video-ati>)包 时被满足。
  * 你也许会需要移除 `/etc/profile.d/ati-flgrx.sh` 和 `/etc/profile.d/lib32-catalyst`（如果他们存在），否则 `r600_dri.so` 将会载入失败，你将得不到3D支持。

**注意：** 你应该从 `/etc/pacman.conf` 移除非官方仓库，然后运行 `# pacman -Syu`，因为那些仓库包含过时的 Xorg 包（为了兼容 `catalyst`），而 [xf86-video-ati](<https://archlinux.org/packages/?name=xf86-video-ati>)包 包需要来自[官方仓库](<../zh-cn/Official_repositories.html> "Official repositories")的最新的 Xorg 包。
...
按如下步骤： 
  ...
  * 如果安装了 [catalyst-hook](<https://aur.archlinux.org/packages/catalyst-hook/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 包，记得关掉它的 systemd 服务的自启动。
  * 如果你在[内核参数](<../zh-cn/Kernel_parameters.html> "Kernel parameters")中指定了 `nomodeset` 而现在你打算使用 KMS，那么删除 `nomodeset`。
...
从[官方仓库](</wzh/index.php?title=Official_repositories_\(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87\)&action=edit&redlink=1> "Official repositories \(简体中文\)（页面不存在）")安装 [acpid](<https://archlinux.org/packages/?name=acpid>)包.启用并运行 acpid [守护进程](<../zh-cn/Daemon_\(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87\).html> "Daemon \(简体中文\)")。 
...
降级 [xorg-server](<https://archlinux.org/packages/?name=xorg-server>)包 或者试试其它[显示管理器](</wzh/index.php?title=Display_manager_\(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87\)&action=edit&redlink=1> "Display manager \(简体中文\)（页面不存在）")比如 [LightDM](<../zh-cn/LightDM.html> "LightDM")。 
...
或以 root 身份打开 `/etc/X11/xorg.conf`，在 _Device_ 段添加 `Option "UseFastTLS" "off"`。 
...
常见错误提示和解决办法： 
  ...
  * 若路径为 `/usr/lib/xorg/modules/dri/fglrx_dri.so`，试着重装 [catalyst](<https://aur.archlinux.org/packages/catalyst/>)AUR[[损坏的链接](<../zh-cn/Help:%E6%93%8D%E4%BD%9C%E6%B5%81%E7%A8%8B.html#%E4%BF%AE%E5%A4%8D%E6%8D%9F%E5%9D%8F%E7%9A%84%E5%8C%85%E9%93%BE%E6%8E%A5> "Help:操作流程")：package not found] 包。
...
若启动了 framebuffer，Catalyst 不能从挂机状态中恢复。在[内核参数](<../zh-cn/Kernel_parameters.html> "Kernel parameters")中添加 `vga=0` 可禁用 framebuffer。 
...
参见[这个错误报告](<https://bugzilla.kernel.org/show_bug.cgi?id=6350>)。 
...
给内核参数添加 `nopat` 和/或 `nomodeset` 到[内核参数](<../zh-cn/Kernel_parameters.html> "Kernel parameters")应该能解决问题。 
...
在 Google 的 Chromium/Chrome 浏览器里，Linux 的 Catalyst 驱动被列入了黑名单。参见 [Chromium#WebGL](<../zh-cn/Chromium.html#WebGL> "Chromium")。 
...
使用 amdcccle（图形界面）你可以选择要修改的显示输出，将欠扫描设置成 0%（aticonfig 默认 15% 欠扫描）。（至少）版本 14.10 有时也会出现显示调整的下面没有欠扫描的滑块的情况。(It is possible as well that the underscan slider will not show under the display's adjustments, as sometimes in (at least) version 14.10.) 
...
[Vari-Bright](<https://support.hp.com/vn-en/document/c02848104>) 动态调整显示面板用电量以节能。 输入以下命令以禁用 VariBright： 
...
然后这时你可以试试 [acpi_call](<https://archlinux.org/packages/?name=acpi_call>)包。MrDeepPurple 准备好了脚本来完成这个任务。脚本在启动和恢复系统的时候通过 systemd 服务运行。 这是他的脚本： 
...
使用 [uvesafb](<../zh-cn/Uvesafb.html> "Uvesafb") 作为 framebuffer 驱动。而且，`uvesafb` 可以为 TTY 设置任意分辨率。 
...
同时，确认已安装有 [polkit 认证代理](<../zh-cn/Polkit.html#Authentication_agents> "Polkit")并正在运行，因为这种情况可能会在某程序想要请求密码但没有认证代理来显示密码对话框时出现。 
...
[更多信息见此](<https://ati.cchtml.com/show_bug.cgi?id=711>)
...
##  参见
  ...
  * [Unofficial Wiki for the ATI Linux Driver](<https://wiki.cchtml.com/index.php/Main_Page>)
  * [Unofficial ATI Linux Driver Bugzilla](<https://ati.cchtml.com/query.cgi>)
