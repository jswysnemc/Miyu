...
**原因：** Article consists mainly of config dumps.（在[Talk:字体配置/中文](<../../zh-cn/Talk:%E5%AD%97%E4%BD%93%E9%85%8D%E7%BD%AE/%E4%B8%AD%E6%96%87.html>)讨论）
...
安装 [ttf-roboto](<https://archlinux.org/packages/?name=ttf-roboto>)包 [noto-fonts](<https://archlinux.org/packages/?name=noto-fonts>)包 [noto-fonts-cjk](<https://archlinux.org/packages/?name=noto-fonts-cjk>)包 [adobe-source-han-sans-cn-fonts](<https://archlinux.org/packages/?name=adobe-source-han-sans-cn-fonts>)包 [adobe-source-han-serif-cn-fonts](<https://archlinux.org/packages/?name=adobe-source-han-serif-cn-fonts>)包 [ttf-dejavu](<https://archlinux.org/packages/?name=ttf-dejavu>)包。 

see [archlinux wiki](<https://wiki.archlinux.org/title/Localization/Chinese> "en:Localization/Chinese") for detail 
...
参见[微软字体](<../../zh-cn/%E5%BE%AE%E8%BD%AF%E5%AD%97%E4%BD%93.html> "微软字体")。 
...
针对中文字体添加“斜体”属性，即可让此字体的“斜体”不再倾斜（注意替换你所使用的中文字体名）。更改此项配置之后需要执行 `fc-cache -f`。
