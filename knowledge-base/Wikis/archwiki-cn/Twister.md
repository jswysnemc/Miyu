**翻译状态：**
  ...
  * 本文（或部分内容）译自 [Twister](<https://wiki.archlinux.org/title/Twister> "arch:Twister")，最近一次同步于 2015-02-12，若英文版本有所[更改](<https://wiki.archlinux.org/title/Twister?diff=0&oldid=360447>)，则您可以帮助同步与[翻译](<../zh-cn/Help:%E7%BF%BB%E8%AF%91.html> "Help:翻译")更改的内容。
  * 您可以在 [ArchWiki 的对应页面](<https://wiki.archlinux.org/title/Twister_\(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87\)?action=history>)找到本文翻译的**原始** 修订历史。
  * 本文可能与英文原文存在出入。
...
AUR中有 [twister-core-git](<https://aur.archlinux.org/packages/twister-core-git/>)AUR 和 [twister-html-git](<https://aur.archlinux.org/packages/twister-html-git/>)AUR这两个包。 
