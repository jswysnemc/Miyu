...
**原因：** Still references `rc.d`.（在 [Talk:Squid#](<../zh-cn/Talk:Squid.html>) 中讨论）
...
[安装](<../zh-cn/Pacman.html> "Pacman")位于[官方软件仓库](<../zh-cn/Official_repositories.html> "Official repositories")的 [squid](<https://archlinux.org/packages/?name=squid>)包。 
