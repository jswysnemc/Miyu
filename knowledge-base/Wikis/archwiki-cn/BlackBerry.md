...
**原因：** 请提供模板的第一个位置参数以概括原因。 (在[Talk:BlackBerry](<../zh-cn/Talk:BlackBerry.html>)讨论)
...
**原因：** Not updated since its initial translation in 2011, out of sync with English page（在 [Talk:BlackBerry#](<../zh-cn/Talk:BlackBerry.html>) 中讨论）
...
`msynctool-stable` \- 可从aur仓库获得 - <https://github.com/aur-archive/msynctool-stable>  
`libopensync-plugin-evolution2-stable` -可从aur仓库获得 - <https://github.com/aur-archive/libopensync-plugin-evolution2-stable>  
`barry` \- 可从aur仓库获得 - [barry](<https://aur.archlinux.org/packages/barry/>)AUR
