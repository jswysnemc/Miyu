...
confext.conf(5) — Configuration files for systemd-sysext  
confext.conf.d(5) — Configuration files for systemd-sysext  
...
file-hierarchy(7) — systemd file system hierarchy requirements  
...
mount.mstack(1) — Mstack Discoverable Disk Images (DDIs)  
...
org.freedesktop.sysupdate1(5) — The D-Bus interface of systemd-sysupdated  
org.freedesktop.timedate1(5) — The D-Bus interface of systemd-timedated  
org.freedesktop.timesync1(5) — The D-Bus interface of systemd-timesyncd  
...
sd-path(3) — APIs to query file system paths  
sd-stub(7) — A simple UEFI kernel boot stub  
sd-varlink(3) — APIs for Varlink IPC  
...
sd_bus_message_dump_json(3) — Produce a string representation of a message for debugging purposes  
...
sd_device_enumerator_add_all_parents(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_match_parent(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_match_property(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_match_property_required(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_match_subsystem(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_match_sysattr(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_match_sysname(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_match_tag(3) — Add a filter to the device enumerator  
sd_device_enumerator_add_nomatch_sysname(3) — Add a filter to the device enumerator  
sd_device_enumerator_allow_uninitialized(3) — Add a filter to the device enumerator  
sd_device_enumerator_get_device_first(3) — Enumerates devices and get the first or next device.  
sd_device_enumerator_get_device_next(3) — Enumerates devices and get the first or next device.  
sd_device_enumerator_get_subsystem_first(3) — Enumerates devices and get the first or next device.  
sd_device_enumerator_get_subsystem_next(3) — Enumerates devices and get the first or next device.  
sd_device_enumerator_new(3) — Create, reference, and release a device enumerator object  
sd_device_enumerator_ref(3) — Create, reference, and release a device enumerator object  
sd_device_enumerator_unref(3) — Create, reference, and release a device enumerator object  
sd_device_enumerator_unrefp(3) — Create, reference, and release a device enumerator object  
sd_device_get_device_id(3) — Returns various fields of device objects  
...
sd_device_get_driver_subsystem(3) — Returns various fields of device objects  
...
sd_event_get_exit_on_idle(3) — Enable event loop exit-on-idle support  
...
sd_event_set_exit_on_idle(3) — Enable event loop exit-on-idle support  
...
sd_json_dispatch_const_string(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_double(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_id128(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_int16(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_int32(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_int64(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_int8(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_intbool(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_signal(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_stdbool(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_string(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_strv(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_tristate(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_uid_gid(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_uint16(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_uint32(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_uint64(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_uint8(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_unsupported(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_variant(3) — Decode JSON variant values and write them to the specified memory  
sd_json_dispatch_variant_noref(3) — Decode JSON variant values and write them to the specified memory  
...
sd_pidfd_get_inode_id(3) — Acquire the 64-bit inode ID of a PID file descriptor (PIDFD)  
...
sd_session_get_extra_device_access(3) — Determine state of a specific session  
...
sd_varlink_get_description(3) — Set or query description of a Varlink connection object  
sd_varlink_is_connected(3) — Query if a Varlink connection object is currently connected or idle  
sd_varlink_is_idle(3) — Query if a Varlink connection object is currently connected or idle  
sd_varlink_push_dup_fd(3) — Submit a file descriptor to send along with the next outgoing Varlink message  
sd_varlink_push_fd(3) — Submit a file descriptor to send along with the next outgoing Varlink message  
sd_varlink_send(3) — Enqueues a Varlink method call, not expecting a reply  
sd_varlink_sendb(3) — Enqueues a Varlink method call, not expecting a reply  
sd_varlink_sendbo(3) — Enqueues a Varlink method call, not expecting a reply  
sd_varlink_server_new(3) — Allocate Varlink server object  
sd_varlink_set_description(3) — Set or query description of a Varlink connection object  
sd_varlink_set_relative_timeout(3) — Set method call time-out  
...
sysext.conf(5) — Configuration files for systemd-sysext  
sysext.conf.d(5) — Configuration files for systemd-sysext  
...
systemd-boot-clear-sysfail.service(8) — Clear LoaderEntrySysFail entry  
...
systemd-confext-initrd.service(8) — Activates System Extension Images  
...
systemd-factory-reset(8) — Request or complete a factory reset operation, or query current factory reset mode  
systemd-factory-reset-complete.service(8) — Request or complete a factory reset operation, or query current factory reset mode  
systemd-factory-reset-generator(8) — Pull factory-reset-now.target into the initial boot transaction when factory reset has been requested  
systemd-factory-reset-request.service(8) — Request or complete a factory reset operation, or query current factory reset mode  
systemd-factory-reset.socket(8) — Request or complete a factory reset operation, or query current factory reset mode  
systemd-factory-reset@.service(8) — Request or complete a factory reset operation, or query current factory reset mode  
...
systemd-import-generator(8) — Generator for automatically downloading disk images at boot  
...
systemd-keyutil(1) — Perform various operations on private keys and X.509 certificates  
...
systemd-loop@.service(8) — Attach a loopback block device  
...
systemd-measure(1) — Pre-calculate and sign expected TPM2 PCR 11 values for booted unified kernel images  
...
systemd-mstack(1) — Mstack Discoverable Disk Images (DDIs)  
systemd-mute-console(1) — Temporarily mute kernel log output and service manager status output to the system console  
systemd-mute-console.socket(1) — Temporarily mute kernel log output and service manager status output to the system console  
systemd-mute-console@.service(1) — Temporarily mute kernel log output and service manager status output to the system console  
...
systemd-nspawn(1) — Spawn a command or OS in a lightweight container  
...
systemd-pcrextend(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
systemd-pcrfs-root.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
systemd-pcrfs@.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
...
systemd-pcrmachine.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
systemd-pcrnvdone.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
systemd-pcrphase-initrd.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
systemd-pcrphase-sysinit.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
systemd-pcrphase.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
systemd-pcrproduct.service(8) — Measure boot phases, machine ID, product UUID and file system identity into TPM PCRs and NvPCRs  
...
systemd-pty-forward(1) — Run a command with a custom terminal background color or title  
systemd-quotacheck(8) — File system quota checker logic  
systemd-quotacheck-root.service(8) — File system quota checker logic  
...
systemd-repart(8) — Automatically grow and add partitions, and generate disk images (DDIs)  
systemd-repart.service(8) — Automatically grow and add partitions, and generate disk images (DDIs)  
systemd-report(1) — Generate report of system facts and metrics  
...
systemd-sbsign(1) — Sign PE binaries for EFI Secure Boot  
...
systemd-ssh-issue(1) — Generator for SSH login prompt drop-ins  
...
systemd-sysext-initrd.service(8) — Activates System Extension Images  
...
systemd-sysupdated(8) — System Update Service  
systemd-sysupdated.service(8) — System Update Service  
...
systemd-tpm2-clear.service(8) — Request that the TPM security chip is cleared on next boot  
systemd-tpm2-generator(8) — Generator for inserting TPM2 synchronization point in the boot process  
systemd-tpm2-setup(8) — Set up the TPM2 Storage Root Key (SRK) and initialize NvPCRs at boot  
systemd-tpm2-setup-early.service(8) — Set up the TPM2 Storage Root Key (SRK) and initialize NvPCRs at boot  
systemd-tpm2-setup.service(8) — Set up the TPM2 Storage Root Key (SRK) and initialize NvPCRs at boot  
...
systemd-udevd-varlink.socket(8) — Device event managing daemon  
...
systemd-update-done(8) — Mark /etc/ and /var/ as fully updated  
systemd-update-done.service(8) — Mark /etc/ and /var/ as fully updated  
systemd-update-utmp(8) — Write audit and utmp updates at bootup and shutdown  
systemd-update-utmp.service(8) — Write audit and utmp updates at bootup and shutdown  
...
systemd-validatefs@.service(8) — Validate File System Mount Constraint Data  
...
sysupdate.features(5) — Definition Files for Optional Features  
...
updatectl(1) — Control the system update service  
...
This index contains 1268 entries, referring to 441 individual manual pages.
