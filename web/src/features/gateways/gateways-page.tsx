...
import { Cable, CircleStop, ExternalLink, Play, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="management-page">
      <header className="management-hero">
        ...
        <div><span className="eyebrow">Messaging gateways</span><h1>网关管理</h1><p>查看 QQ 与微信网关的配置和运行进程，在网页中启动或停止受管理任务。</p></div>
      ...
      <div className="gateway-config-link"><span>网关凭据和监听地址属于 Miyu 配置。</span><Link to="/settings">打开配置管理 <ExternalLink size={13} /></Link></div>
