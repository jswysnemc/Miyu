import { FileCode2, GitCompareArrows, Maximize2, Minimize2, PanelBottomOpen, PanelLeftClose, PanelRightClose } from "lucide-react";
 ...
 * 渲染文件、变更和终端工作区。
 *
 * @param props 文件选择状态和面板关闭回调
 * @returns 右侧工作区面板
 */
export function WorkspacePane({ selectedFile, onSelectFile, onClearFile, onClose, onToggleChat, onToggleMaximized, onOpenTerminal, maximized }: WorkspacePaneProps) {
  ...
  return (
    <div className="workspace-pane">
      <div className="pane-tabs" role="tablist" aria-label="工作区面板">
        ...
        <button type="button" className="pane-control" onClick={onOpenTerminal} aria-label="打开底部终端"><PanelBottomOpen size={15} /></button>
