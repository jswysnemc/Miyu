...
/// 返回:
/// - QQ 发送目标
async fn resolve_qq_target(paths: &MiyuPaths, config: &AppConfig) -> Result<ActiveChannelTarget> {
...
/// 返回:
/// - 微信发送目标
fn resolve_weixin_target(paths: &MiyuPaths, config: &AppConfig) -> Result<ActiveChannelTarget> {
