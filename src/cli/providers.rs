...
pub(super) fn run_providers(paths: &MiyuPaths, args: ProvidersArgs) -> Result<()> {
...
/// 返回:
/// - 设置是否成功
pub(super) fn run_set(paths: &MiyuPaths, args: SetArgs) -> Result<()> {
    match args.command {
...
/// 返回:
/// - 设置是否成功
pub(super) fn run_set_thinking(paths: &MiyuPaths, args: SetThinkingArgs) -> Result<()> {
